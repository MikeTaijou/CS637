...
forktest(void)
{
  ...
  printf(1, "fork test\n");
  39:	c7 44 24 04 28 04 00 	movl   $0x428,0x4(%esp)
  40:	00 
  ...
  50:	0f 84 7e 00 00 00    	je     d4 <forktest+0xa4>
{
  ...
  a2:	c7 44 24 04 5a 04 00 	movl   $0x45a,0x4(%esp)
  a9:	00 
  ...
  if(n == 1000){
    printf(1, "fork claimed to work 1000 times!\n");
  c0:	c7 44 24 04 68 04 00 	movl   $0x468,0x4(%esp)
  c7:	00 
  ...
  for(; n > 0; n--){
    if(wait() < 0){
      printf(1, "wait stopped early\n");
  d9:	c7 44 24 04 33 04 00 	movl   $0x433,0x4(%esp)
  e0:	00 
  ...
  if(wait() != -1){
    printf(1, "wait got too many\n");
  f2:	c7 44 24 04 47 04 00 	movl   $0x447,0x4(%esp)
  f9:	00 
...
memset(void *dst, int c, uint n)
{
  ...
  d = dst;
  while(n-- > 0)
 1ee:	39 c2                	cmp    %eax,%edx
 1f0:	75 f6                	jne    1e8 <memset+0x18>
    *d++ = c;
  return dst;
}
