...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
       6:	a1 d0 45 00 00       	mov    0x45d0,%eax
       b:	c7 44 24 04 58 33 00 	movl   $0x3358,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 85 2f 00 00       	call   2fa0 <printf>
  fd = open("echo", 0);
      1b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
      22:	00 
      23:	c7 04 24 63 33 00 00 	movl   $0x3363,(%esp)
  ...
  fd = open("doesnotexist", 0);
      ...
      42:	00 
      43:	c7 04 24 7b 33 00 00 	movl   $0x337b,(%esp)
  ...
  printf(stdout, "open test ok\n");
      53:	a1 d0 45 00 00       	mov    0x45d0,%eax
      58:	c7 44 24 04 a6 33 00 	movl   $0x33a6,0x4(%esp)
      5f:	00 
      60:	89 04 24             	mov    %eax,(%esp)
      63:	e8 38 2f 00 00       	call   2fa0 <printf>
}
      68:	c9                   	leave  
      69:	c3                   	ret    
  int fd;
  ...
  if(fd < 0){
    printf(stdout, "open echo failed!\n");
      6a:	a1 d0 45 00 00       	mov    0x45d0,%eax
      6f:	c7 44 24 04 68 33 00 	movl   $0x3368,0x4(%esp)
      76:	00 
      77:	89 04 24             	mov    %eax,(%esp)
      7a:	e8 21 2f 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(fd >= 0){
    printf(stdout, "open doesnotexist succeeded!\n");
      84:	a1 d0 45 00 00       	mov    0x45d0,%eax
      89:	c7 44 24 04 88 33 00 	movl   $0x3388,0x4(%esp)
      90:	00 
      91:	89 04 24             	mov    %eax,(%esp)
      94:	e8 07 2f 00 00       	call   2fa0 <printf>
    exit();
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
      a9:	c7 44 24 04 b4 33 00 	movl   $0x33b4,0x4(%esp)
      b0:	00 
      b1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
      b8:	e8 e3 2e 00 00       	call   2fa0 <printf>
      ...
      c0:	0f 84 7e 00 00 00    	je     144 <forktest+0xa4>
{
  ...
  printf(1, "fork test OK\n");
     112:	c7 44 24 04 e6 33 00 	movl   $0x33e6,0x4(%esp)
     119:	00 
     11a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     121:	e8 7a 2e 00 00       	call   2fa0 <printf>
}
  ...
  if(n == 1000){
    printf(1, "fork claimed to work 1000 times!\n");
     130:	c7 44 24 04 40 40 00 	movl   $0x4040,0x4(%esp)
     137:	00 
     138:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     13f:	e8 5c 2e 00 00       	call   2fa0 <printf>
    exit();
  ...
  for(; n > 0; n--){
    if(wait() < 0){
      printf(1, "wait stopped early\n");
     149:	c7 44 24 04 bf 33 00 	movl   $0x33bf,0x4(%esp)
     150:	00 
     151:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     158:	e8 43 2e 00 00       	call   2fa0 <printf>
      exit();
  ...
  if(wait() != -1){
    printf(1, "wait got too many\n");
     162:	c7 44 24 04 d3 33 00 	movl   $0x33d3,0x4(%esp)
     169:	00 
     16a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     171:	e8 2a 2e 00 00       	call   2fa0 <printf>
    exit();
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     1ba:	7d d4                	jge    190 <exitwait+0x10>
      printf(1, "fork failed\n");
     1bc:	c7 44 24 04 f4 33 00 	movl   $0x33f4,0x4(%esp)
     1c3:	00 
     1c4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     1cb:	e8 d0 2d 00 00       	call   2fa0 <printf>
    } else {
      exit();
    }
  }
  printf(1, "exitwait ok\n");
    ...
    if(pid){
     ...
     1d8:	c7 44 24 04 01 34 00 	movl   $0x3401,0x4(%esp)
     1df:	00 
     1e0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     1e7:	e8 b4 2d 00 00       	call   2fa0 <printf>
    } else {
      exit();
    }
  }
  ...
  printf(1, "exitwait ok\n");
     1f8:	c7 44 24 04 11 34 00 	movl   $0x3411,0x4(%esp)
     1ff:	00 
     200:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     207:	e8 94 2d 00 00       	call   2fa0 <printf>
}
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
     226:	c7 44 24 04 1e 34 00 	movl   $0x341e,0x4(%esp)
     22d:	00 
     22e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     235:	e8 66 2d 00 00       	call   2fa0 <printf>

  if(mkdir("12345678901234") != 0){
     23a:	c7 04 24 59 34 00 00 	movl   $0x3459,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
     24e:	c7 04 24 64 40 00 00 	movl   $0x4064,(%esp)
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
     ...
     269:	00 
     26a:	c7 04 24 b4 40 00 00 	movl   $0x40b4,(%esp)
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
     ...
     28d:	00 
     28e:	c7 04 24 24 41 00 00 	movl   $0x4124,(%esp)
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
     2aa:	c7 04 24 4a 34 00 00 	movl   $0x344a,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
     2be:	c7 04 24 c0 41 00 00 	movl   $0x41c0,(%esp)
  ...
  printf(1, "fourteen ok\n");
     2d2:	c7 44 24 04 68 34 00 	movl   $0x3468,0x4(%esp)
     2d9:	00 
     2da:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     2e1:	e8 ba 2c 00 00       	call   2fa0 <printf>
}
     2e6:	c9                   	leave  
     2e7:	c3                   	ret    
  ...
  if(mkdir("12345678901234") != 0){
    printf(1, "mkdir 12345678901234 failed\n");
     2e8:	c7 44 24 04 2d 34 00 	movl   $0x342d,0x4(%esp)
     2ef:	00 
     2f0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     2f7:	e8 a4 2c 00 00       	call   2fa0 <printf>
    exit();
     2fc:	e8 47 2b 00 00       	call   2e48 <exit>
  }
  if(mkdir("12345678901234/123456789012345") != 0){
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
     301:	c7 44 24 04 84 40 00 	movl   $0x4084,0x4(%esp)
     308:	00 
     309:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     310:	e8 8b 2c 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
     31a:	c7 44 24 04 e4 40 00 	movl   $0x40e4,0x4(%esp)
     321:	00 
     322:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     329:	e8 72 2c 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
     333:	c7 44 24 04 54 41 00 	movl   $0x4154,0x4(%esp)
     33a:	00 
     33b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     342:	e8 59 2c 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
     34c:	c7 44 24 04 90 41 00 	movl   $0x4190,0x4(%esp)
     353:	00 
     354:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     35b:	e8 40 2c 00 00       	call   2fa0 <printf>
    exit();
     360:	e8 e3 2a 00 00       	call   2e48 <exit>
  }
  if(mkdir("123456789012345/12345678901234") == 0){
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
     365:	c7 44 24 04 e0 41 00 	movl   $0x41e0,0x4(%esp)
     36c:	00 
     36d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     374:	e8 27 2c 00 00       	call   2fa0 <printf>
    exit();
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
     389:	c7 44 24 04 75 34 00 	movl   $0x3475,0x4(%esp)
     390:	00 
     391:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     398:	e8 03 2c 00 00       	call   2fa0 <printf>
     39d:	8d 76 00             	lea    0x0(%esi),%esi

  // the 50 is NINODE
  for(i = 0; i < 50 + 1; i++){
    if(mkdir("irefd") != 0){
     3a0:	c7 04 24 86 34 00 00 	movl   $0x3486,(%esp)
    ...
    if(chdir("irefd") != 0){
     3b4:	c7 04 24 86 34 00 00 	movl   $0x3486,(%esp)
    ...
    mkdir("");
     3c8:	c7 04 24 37 3f 00 00 	movl   $0x3f37,(%esp)
     3cf:	e8 dc 2a 00 00       	call   2eb0 <mkdir>
    link("README", "");
     3d4:	c7 44 24 04 37 3f 00 	movl   $0x3f37,0x4(%esp)
     3db:	00 
     3dc:	c7 04 24 b4 34 00 00 	movl   $0x34b4,(%esp)
     3e3:	e8 c0 2a 00 00       	call   2ea8 <link>
    fd = open("", O_CREATE);
     3e8:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
     3ef:	00 
     3f0:	c7 04 24 37 3f 00 00 	movl   $0x3f37,(%esp)
    ...
    fd = open("xx", O_CREATE);
     ...
     40f:	00 
     410:	c7 04 24 26 3a 00 00 	movl   $0x3a26,(%esp)
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    if(fd >= 0)
      close(fd);
    unlink("xx");
     42b:	c7 04 24 26 3a 00 00 	movl   $0x3a26,(%esp)
  ...
  chdir("/");
     440:	c7 04 24 bb 34 00 00 	movl   $0x34bb,(%esp)
     447:	e8 6c 2a 00 00       	call   2eb8 <chdir>
  printf(1, "empty file name OK\n");
     44c:	c7 44 24 04 bd 34 00 	movl   $0x34bd,0x4(%esp)
     453:	00 
     454:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     45b:	e8 40 2b 00 00       	call   2fa0 <printf>
}
  ...
  for(i = 0; i < 50 + 1; i++){
    if(mkdir("irefd") != 0){
      printf(1, "mkdir irefd failed\n");
     466:	c7 44 24 04 8c 34 00 	movl   $0x348c,0x4(%esp)
     46d:	00 
     46e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     475:	e8 26 2b 00 00       	call   2fa0 <printf>
      exit();
     47a:	e8 c9 29 00 00       	call   2e48 <exit>
    }
    if(chdir("irefd") != 0){
      printf(1, "chdir irefd failed\n");
     47f:	c7 44 24 04 a0 34 00 	movl   $0x34a0,0x4(%esp)
     486:	00 
     487:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     48e:	e8 0d 2b 00 00       	call   2fa0 <printf>
      exit();
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
     4a6:	c7 44 24 04 d1 34 00 	movl   $0x34d1,0x4(%esp)
     4ad:	00 
     4ae:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     4b5:	e8 e6 2a 00 00       	call   2fa0 <printf>
  if(mkdir("dots") != 0){
     4ba:	c7 04 24 dd 34 00 00 	movl   $0x34dd,(%esp)
  ...
  if(chdir("dots") != 0){
     4ce:	c7 04 24 dd 34 00 00 	movl   $0x34dd,(%esp)
  ...
  if(unlink(".") == 0){
     4e2:	c7 04 24 44 39 00 00 	movl   $0x3944,(%esp)
  ...
  if(unlink("..") == 0){
     4f6:	c7 04 24 43 39 00 00 	movl   $0x3943,(%esp)
  ...
  if(chdir("/") != 0){
     50a:	c7 04 24 bb 34 00 00 	movl   $0x34bb,(%esp)
  ...
  if(unlink("dots/.") == 0){
     51e:	c7 04 24 35 35 00 00 	movl   $0x3535,(%esp)
  ...
  if(unlink("dots/..") == 0){
     532:	c7 04 24 53 35 00 00 	movl   $0x3553,(%esp)
  ...
  if(unlink("dots") != 0){
     546:	c7 04 24 dd 34 00 00 	movl   $0x34dd,(%esp)
  ...
  printf(1, "rmdot ok\n");
     55a:	c7 44 24 04 88 35 00 	movl   $0x3588,0x4(%esp)
     561:	00 
     562:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     569:	e8 32 2a 00 00       	call   2fa0 <printf>
}
     56e:	c9                   	leave  
     56f:	c3                   	ret    
void
rmdot(void)
{
  ...
  if(mkdir("dots") != 0){
    printf(1, "mkdir dots failed\n");
     570:	c7 44 24 04 e2 34 00 	movl   $0x34e2,0x4(%esp)
     577:	00 
     578:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     57f:	e8 1c 2a 00 00       	call   2fa0 <printf>
    exit();
     584:	e8 bf 28 00 00       	call   2e48 <exit>
  }
  if(chdir("dots") != 0){
    printf(1, "chdir dots failed\n");
     589:	c7 44 24 04 f5 34 00 	movl   $0x34f5,0x4(%esp)
     590:	00 
     591:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     598:	e8 03 2a 00 00       	call   2fa0 <printf>
    exit();
     59d:	e8 a6 28 00 00       	call   2e48 <exit>
  }
  if(unlink(".") == 0){
    printf(1, "rm . worked!\n");
     5a2:	c7 44 24 04 08 35 00 	movl   $0x3508,0x4(%esp)
     5a9:	00 
     5aa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     5b1:	e8 ea 29 00 00       	call   2fa0 <printf>
    exit();
     5b6:	e8 8d 28 00 00       	call   2e48 <exit>
  }
  if(unlink("..") == 0){
    printf(1, "rm .. worked!\n");
     5bb:	c7 44 24 04 16 35 00 	movl   $0x3516,0x4(%esp)
     5c2:	00 
     5c3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     5ca:	e8 d1 29 00 00       	call   2fa0 <printf>
    exit();
     5cf:	e8 74 28 00 00       	call   2e48 <exit>
  }
  if(chdir("/") != 0){
    printf(1, "chdir / failed\n");
     5d4:	c7 44 24 04 25 35 00 	movl   $0x3525,0x4(%esp)
     5db:	00 
     5dc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     5e3:	e8 b8 29 00 00       	call   2fa0 <printf>
    exit();
     5e8:	e8 5b 28 00 00       	call   2e48 <exit>
  }
  if(unlink("dots/.") == 0){
    printf(1, "unlink dots/. worked!\n");
     5ed:	c7 44 24 04 3c 35 00 	movl   $0x353c,0x4(%esp)
     5f4:	00 
     5f5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     5fc:	e8 9f 29 00 00       	call   2fa0 <printf>
    exit();
     601:	e8 42 28 00 00       	call   2e48 <exit>
  }
  if(unlink("dots/..") == 0){
    printf(1, "unlink dots/.. worked!\n");
     606:	c7 44 24 04 5b 35 00 	movl   $0x355b,0x4(%esp)
     60d:	00 
     60e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     615:	e8 86 29 00 00       	call   2fa0 <printf>
    exit();
     61a:	e8 29 28 00 00       	call   2e48 <exit>
  }
  if(unlink("dots") != 0){
    printf(1, "unlink dots failed!\n");
     61f:	c7 44 24 04 73 35 00 	movl   $0x3573,0x4(%esp)
     626:	00 
     627:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     62e:	e8 6d 29 00 00       	call   2fa0 <printf>
    exit();
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
     648:	c7 44 24 04 92 35 00 	movl   $0x3592,0x4(%esp)
     64f:	00 
     650:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     657:	e8 44 29 00 00       	call   2fa0 <printf>
  unlink("bd");
     65c:	c7 04 24 9f 35 00 00 	movl   $0x359f,(%esp)
     663:	e8 30 28 00 00       	call   2e98 <unlink>

  fd = open("bd", O_CREATE);
     668:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
     66f:	00 
     670:	c7 04 24 9f 35 00 00 	movl   $0x359f,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    if(link("bd", name) != 0){
     ...
     6ba:	c7 04 24 9f 35 00 00 	movl   $0x359f,(%esp)
  ...
  unlink("bd");
     6d5:	c7 04 24 9f 35 00 00 	movl   $0x359f,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    if(unlink(name) != 0){
     ...
     71d:	c7 44 24 04 cc 35 00 	movl   $0x35cc,0x4(%esp)
     724:	00 
     725:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     72c:	e8 6f 28 00 00       	call   2fa0 <printf>
      exit();
    ...
    if(link("bd", name) != 0){
      printf(1, "bigdir link failed\n");
     736:	c7 44 24 04 b8 35 00 	movl   $0x35b8,0x4(%esp)
     73d:	00 
     73e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     745:	e8 56 28 00 00       	call   2fa0 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
     74f:	c7 44 24 04 e1 35 00 	movl   $0x35e1,0x4(%esp)
     756:	00 
     757:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     75e:	e8 3d 28 00 00       	call   2fa0 <printf>
}
  ...
  if(fd < 0){
    printf(1, "bigdir create failed\n");
     76a:	c7 44 24 04 a2 35 00 	movl   $0x35a2,0x4(%esp)
     771:	00 
     772:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     779:	e8 22 28 00 00       	call   2fa0 <printf>
    exit();
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     799:	c7 44 24 04 ec 35 00 	movl   $0x35ec,0x4(%esp)
     7a0:	00 
     7a1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     7a8:	e8 f3 27 00 00       	call   2fa0 <printf>
  pid = fork();
  ...
  for(i = 0; i < N; i++){
    ...
    if((i == 0 || i >= N/2) && fd < 0){
     ...
     896:	c7 44 24 04 38 42 00 	movl   $0x4238,0x4(%esp)
     89d:	00 
     89e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     8a5:	e8 f6 26 00 00       	call   2fa0 <printf>
      exit();
    ...
    if((i == 0 || i >= N/2) && fd < 0){
     ...
     900:	c7 44 24 04 38 42 00 	movl   $0x4238,0x4(%esp)
     907:	00 
     908:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     90f:	e8 8c 26 00 00       	call   2fa0 <printf>
      exit();
  ...
  printf(1, "createdelete ok\n");
     969:	c7 44 24 04 0e 36 00 	movl   $0x360e,0x4(%esp)
     970:	00 
     971:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     978:	e8 23 26 00 00       	call   2fa0 <printf>
}
  ...
  name[2] = '\0';
    ...
    if(i > 0 && (i % 2 ) == 0){
     ...
     9b5:	c7 44 24 04 ff 35 00 	movl   $0x35ff,0x4(%esp)
     9bc:	00 
     9bd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9c4:	e8 d7 25 00 00       	call   2fa0 <printf>
        exit();
  ...
  for(i = 0; i < N; i++){
    ...
    if(fd < 0){
      printf(1, "create failed\n");
     9ce:	c7 44 24 04 a9 35 00 	movl   $0x35a9,0x4(%esp)
     9d5:	00 
     9d6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9dd:	e8 be 25 00 00       	call   2fa0 <printf>
      exit();
  ...
  for(i = 0; i < N; i++){
    ...
    if((i == 0 || i >= N/2) && fd < 0){
     ...
     9ee:	c7 44 24 04 14 42 00 	movl   $0x4214,0x4(%esp)
     9f5:	00 
     9f6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9fd:	e8 9e 25 00 00       	call   2fa0 <printf>
      exit();
    ...
    if((i == 0 || i >= N/2) && fd < 0){
     ...
     a0e:	c7 44 24 04 14 42 00 	movl   $0x4214,0x4(%esp)
     a15:	00 
     a16:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a1d:	e8 7e 25 00 00       	call   2fa0 <printf>
      exit();
  ...
  if(pid < 0){
    printf(1, "fork failed\n");
     a27:	c7 44 24 04 f4 33 00 	movl   $0x33f4,0x4(%esp)
     a2e:	00 
     a2f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a36:	e8 65 25 00 00       	call   2fa0 <printf>
    exit();
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     a46:	a1 d0 45 00 00       	mov    0x45d0,%eax
     a4b:	c7 44 24 04 1f 36 00 	movl   $0x361f,0x4(%esp)
     a52:	00 
     a53:	89 04 24             	mov    %eax,(%esp)
     a56:	e8 45 25 00 00       	call   2fa0 <printf>

  if(mkdir("dir0") < 0) {
     a5b:	c7 04 24 2b 36 00 00 	movl   $0x362b,(%esp)
  ...
  if(chdir("dir0") < 0) {
     a6b:	c7 04 24 2b 36 00 00 	movl   $0x362b,(%esp)
  ...
  if(chdir("..") < 0) {
     a7b:	c7 04 24 43 39 00 00 	movl   $0x3943,(%esp)
  ...
  if(unlink("dir0") < 0) {
     a8b:	c7 04 24 2b 36 00 00 	movl   $0x362b,(%esp)
  ...
  printf(stdout, "mkdir test\n");
     a9b:	a1 d0 45 00 00       	mov    0x45d0,%eax
     aa0:	c7 44 24 04 1f 36 00 	movl   $0x361f,0x4(%esp)
     aa7:	00 
     aa8:	89 04 24             	mov    %eax,(%esp)
     aab:	e8 f0 24 00 00       	call   2fa0 <printf>
}
     ab0:	c9                   	leave  
     ab1:	c3                   	ret    
void dirtest(void)
{
  ...
  if(mkdir("dir0") < 0) {
    printf(stdout, "mkdir failed\n");
     ab2:	a1 d0 45 00 00       	mov    0x45d0,%eax
     ab7:	c7 44 24 04 30 36 00 	movl   $0x3630,0x4(%esp)
     abe:	00 
     abf:	89 04 24             	mov    %eax,(%esp)
     ac2:	e8 d9 24 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(chdir("dir0") < 0) {
    printf(stdout, "chdir dir0 failed\n");
     acc:	a1 d0 45 00 00       	mov    0x45d0,%eax
     ad1:	c7 44 24 04 3e 36 00 	movl   $0x363e,0x4(%esp)
     ad8:	00 
     ad9:	89 04 24             	mov    %eax,(%esp)
     adc:	e8 bf 24 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(chdir("..") < 0) {
    printf(stdout, "chdir .. failed\n");
     ae6:	a1 d0 45 00 00       	mov    0x45d0,%eax
     aeb:	c7 44 24 04 51 36 00 	movl   $0x3651,0x4(%esp)
     af2:	00 
     af3:	89 04 24             	mov    %eax,(%esp)
     af6:	e8 a5 24 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(unlink("dir0") < 0) {
    printf(stdout, "unlink dir0 failed\n");
     b00:	a1 d0 45 00 00       	mov    0x45d0,%eax
     b05:	c7 44 24 04 62 36 00 	movl   $0x3662,0x4(%esp)
     b0c:	00 
     b0d:	89 04 24             	mov    %eax,(%esp)
     b10:	e8 8b 24 00 00       	call   2fa0 <printf>
    exit();
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     b2c:	a1 d0 45 00 00       	mov    0x45d0,%eax
     b31:	c7 44 24 04 58 42 00 	movl   $0x4258,0x4(%esp)
     b38:	00 
     b39:	89 04 24             	mov    %eax,(%esp)
     b3c:	e8 5f 24 00 00       	call   2fa0 <printf>

  name[0] = 'a';
     b41:	c6 05 00 4e 00 00 61 	movb   $0x61,0x4e00
  name[2] = '\0';
     b48:	c6 05 02 4e 00 00 00 	movb   $0x0,0x4e02
     b4f:	90                   	nop    
  for(i = 0; i < 52; i++) {
    name[1] = '0' + i;
     b50:	88 1d 01 4e 00 00    	mov    %bl,0x4e01
    fd = open(name, O_CREATE|O_RDWR);
    close(fd);
  ...
  for(i = 0; i < 52; i++) {
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     b60:	00 
     b61:	c7 04 24 00 4e 00 00 	movl   $0x4e00,(%esp)
  ...
  name[0] = 'a';
     b7a:	c6 05 00 4e 00 00 61 	movb   $0x61,0x4e00
  name[2] = '\0';
     b81:	bb 30 00 00 00       	mov    $0x30,%ebx
     b86:	c6 05 02 4e 00 00 00 	movb   $0x0,0x4e02
     b8d:	8d 76 00             	lea    0x0(%esi),%esi
  for(i = 0; i < 52; i++) {
    name[1] = '0' + i;
     b90:	88 1d 01 4e 00 00    	mov    %bl,0x4e01
    unlink(name);
     b96:	83 c3 01             	add    $0x1,%ebx
     b99:	c7 04 24 00 4e 00 00 	movl   $0x4e00,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     baa:	a1 d0 45 00 00       	mov    0x45d0,%eax
     baf:	c7 44 24 04 80 42 00 	movl   $0x4280,0x4(%esp)
     bb6:	00 
     bb7:	89 04 24             	mov    %eax,(%esp)
     bba:	e8 e1 23 00 00       	call   2fa0 <printf>
}
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
     bd7:	c7 44 24 04 76 36 00 	movl   $0x3676,0x4(%esp)
     bde:	00 
     bdf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     be6:	e8 b5 23 00 00       	call   2fa0 <printf>

  fd = open("dirfile", O_CREATE);
     beb:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
     bf2:	00 
     bf3:	c7 04 24 83 36 00 00 	movl   $0x3683,(%esp)
  ...
  if(chdir("dirfile") == 0){
     c0f:	c7 04 24 83 36 00 00 	movl   $0x3683,(%esp)
  ...
  fd = open("dirfile/xx", 0);
     ...
     c2a:	00 
     c2b:	c7 04 24 bc 36 00 00 	movl   $0x36bc,(%esp)
  ...
  fd = open("dirfile/xx", O_CREATE);
     ...
     c46:	00 
     c47:	c7 04 24 bc 36 00 00 	movl   $0x36bc,(%esp)
  ...
  if(mkdir("dirfile/xx") == 0){
     c5b:	c7 04 24 bc 36 00 00 	movl   $0x36bc,(%esp)
  ...
  if(unlink("dirfile/xx") == 0){
     c6f:	c7 04 24 bc 36 00 00 	movl   $0x36bc,(%esp)
  ...
  if(link("README", "dirfile/xx") == 0){
     c83:	c7 44 24 04 bc 36 00 	movl   $0x36bc,0x4(%esp)
     c8a:	00 
     c8b:	c7 04 24 b4 34 00 00 	movl   $0x34b4,(%esp)
  ...
  if(unlink("dirfile") != 0){
     c9f:	c7 04 24 83 36 00 00 	movl   $0x3683,(%esp)
  ...
  fd = open(".", O_RDWR);
     ...
     cba:	00 
     cbb:	c7 04 24 44 39 00 00 	movl   $0x3944,(%esp)
  ...
  fd = open(".", 0);
     ...
     cd6:	00 
     cd7:	c7 04 24 44 39 00 00 	movl   $0x3944,(%esp)
     cde:	e8 a5 21 00 00       	call   2e88 <open>
  if(write(fd, "x", 1) > 0){
     ce3:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
     cea:	00 
     ceb:	c7 44 24 04 27 3a 00 	movl   $0x3a27,0x4(%esp)
     cf2:	00 
  fd = open(".", O_RDWR);
  if(fd >= 0){
    printf(1, "open . for writing succeeded!\n");
  ...
  printf(1, "dir vs file OK\n");
     d0d:	c7 44 24 04 4c 37 00 	movl   $0x374c,0x4(%esp)
     d14:	00 
     d15:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d1c:	e8 7f 22 00 00       	call   2fa0 <printf>
}
  ...
  if(fd >= 0){
    printf(1, "create dirfile/xx succeeded!\n");
     d28:	c7 44 24 04 c7 36 00 	movl   $0x36c7,0x4(%esp)
     d2f:	00 
     d30:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d37:	e8 64 22 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "create dirfile failed\n");
     d41:	c7 44 24 04 8b 36 00 	movl   $0x368b,0x4(%esp)
     d48:	00 
     d49:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d50:	e8 4b 22 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(chdir("dirfile") == 0){
    printf(1, "chdir dirfile succeeded!\n");
     d5a:	c7 44 24 04 a2 36 00 	movl   $0x36a2,0x4(%esp)
     d61:	00 
     d62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d69:	e8 32 22 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(mkdir("dirfile/xx") == 0){
    printf(1, "mkdir dirfile/xx succeeded!\n");
     d73:	c7 44 24 04 e5 36 00 	movl   $0x36e5,0x4(%esp)
     d7a:	00 
     d7b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d82:	e8 19 22 00 00       	call   2fa0 <printf>
    exit();
     d87:	e8 bc 20 00 00       	call   2e48 <exit>
  }
  if(unlink("dirfile/xx") == 0){
    printf(1, "unlink dirfile/xx succeeded!\n");
     d8c:	c7 44 24 04 02 37 00 	movl   $0x3702,0x4(%esp)
     d93:	00 
     d94:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d9b:	e8 00 22 00 00       	call   2fa0 <printf>
    exit();
     da0:	e8 a3 20 00 00       	call   2e48 <exit>
  }
  if(link("README", "dirfile/xx") == 0){
    printf(1, "link to dirfile/xx succeeded!\n");
     da5:	c7 44 24 04 a8 42 00 	movl   $0x42a8,0x4(%esp)
     dac:	00 
     dad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     db4:	e8 e7 21 00 00       	call   2fa0 <printf>
    exit();
     db9:	e8 8a 20 00 00       	call   2e48 <exit>
  }
  if(unlink("dirfile") != 0){
    printf(1, "unlink dirfile failed!\n");
     dbe:	c7 44 24 04 20 37 00 	movl   $0x3720,0x4(%esp)
     dc5:	00 
     dc6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     dcd:	e8 ce 21 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(fd >= 0){
    printf(1, "open . for writing succeeded!\n");
     dd7:	c7 44 24 04 c8 42 00 	movl   $0x42c8,0x4(%esp)
     dde:	00 
     ddf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     de6:	e8 b5 21 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    printf(1, "write . succeeded!\n");
     df0:	c7 44 24 04 38 37 00 	movl   $0x3738,0x4(%esp)
     df7:	00 
     df8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     dff:	e8 9c 21 00 00       	call   2fa0 <printf>
    exit();
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
     e1b:	c7 44 24 04 5c 37 00 	movl   $0x375c,0x4(%esp)
     e22:	00 
     e23:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e2a:	e8 71 21 00 00       	call   2fa0 <printf>

  unlink("bigfile");
     e2f:	c7 04 24 78 37 00 00 	movl   $0x3778,(%esp)
     e36:	e8 5d 20 00 00       	call   2e98 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
     e3b:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     e42:	00 
     e43:	c7 04 24 78 37 00 00 	movl   $0x3778,(%esp)
  ...
  for(i = 0; i < 20; i++){
    memset(buf, i, 600);
     ...
     e6c:	c7 04 24 00 46 00 00 	movl   $0x4600,(%esp)
     e73:	e8 28 1e 00 00       	call   2ca0 <memset>
    if(write(fd, buf, 600) != 600){
     e78:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
     e7f:	00 
     e80:	c7 44 24 04 00 46 00 	movl   $0x4600,0x4(%esp)
     e87:	00 
  ...
  fd = open("bigfile", 0);
     ...
     eb6:	00 
     eb7:	c7 04 24 78 37 00 00 	movl   $0x3778,(%esp)
  ...
  if(fd < 0){
    ...
    if(buf[0] != i/2 || buf[299] != i/2){
     ede:	0f be 15 00 46 00 00 	movsbl 0x4600,%edx
     ee5:	89 d8                	mov    %ebx,%eax
     ee7:	d1 f8                	sar    %eax
     ee9:	39 c2                	cmp    %eax,%edx
     eeb:	75 7b                	jne    f68 <bigfile+0x158>
     eed:	0f be 05 2b 47 00 00 	movsbl 0x472b,%eax
  ...
  for(i = 0; ; i++){
    ...
    cc = read(fd, buf, 300);
     ...
     f08:	00 
     f09:	c7 44 24 04 00 46 00 	movl   $0x4600,0x4(%esp)
     f10:	00 
  ...
  unlink("bigfile");
     f3e:	c7 04 24 78 37 00 00 	movl   $0x3778,(%esp)
     f45:	e8 4e 1f 00 00       	call   2e98 <unlink>

  printf(1, "bigfile test ok\n");
     f4a:	c7 44 24 04 07 38 00 	movl   $0x3807,0x4(%esp)
     f51:	00 
     f52:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f59:	e8 42 20 00 00       	call   2fa0 <printf>
}
    ...
    if(buf[0] != i/2 || buf[299] != i/2){
      printf(1, "read bigfile wrong data\n");
     f68:	c7 44 24 04 d4 37 00 	movl   $0x37d4,0x4(%esp)
     f6f:	00 
     f70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f77:	e8 24 20 00 00       	call   2fa0 <printf>
      exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    if(write(fd, buf, 600) != 600){
      printf(1, "write bigfile failed\n");
     f81:	c7 44 24 04 80 37 00 	movl   $0x3780,0x4(%esp)
     f88:	00 
     f89:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f90:	e8 0b 20 00 00       	call   2fa0 <printf>
      exit();
  ...
  for(i = 0; ; i++){
    ...
    if(cc < 0){
      printf(1, "read bigfile failed\n");
     f9a:	c7 44 24 04 ab 37 00 	movl   $0x37ab,0x4(%esp)
     fa1:	00 
     fa2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fa9:	e8 f2 1f 00 00       	call   2fa0 <printf>
      exit();
    ...
    if(cc != 300){
      printf(1, "short read bigfile\n");
     fb3:	c7 44 24 04 c0 37 00 	movl   $0x37c0,0x4(%esp)
     fba:	00 
     fbb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fc2:	e8 d9 1f 00 00       	call   2fa0 <printf>
      exit();
  ...
  if(fd < 0){
    printf(1, "cannot create bigfile");
     fcc:	c7 44 24 04 6a 37 00 	movl   $0x376a,0x4(%esp)
     fd3:	00 
     fd4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fdb:	e8 c0 1f 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "cannot open bigfile\n");
     fe5:	c7 44 24 04 96 37 00 	movl   $0x3796,0x4(%esp)
     fec:	00 
     fed:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ff4:	e8 a7 1f 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(total != 20*600){
    printf(1, "read bigfile wrong total\n");
     ffe:	c7 44 24 04 ed 37 00 	movl   $0x37ed,0x4(%esp)
    1005:	00 
    1006:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    100d:	e8 8e 1f 00 00       	call   2fa0 <printf>
    exit();
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1027:	c7 44 24 04 18 38 00 	movl   $0x3818,0x4(%esp)
    102e:	00 
    102f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1036:	e8 65 1f 00 00       	call   2fa0 <printf>

  unlink("ff");
    103b:	c7 04 24 a1 38 00 00 	movl   $0x38a1,(%esp)
    1042:	e8 51 1e 00 00       	call   2e98 <unlink>
  if(mkdir("dd") != 0){
    1047:	c7 04 24 3e 39 00 00 	movl   $0x393e,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1062:	00 
    1063:	c7 04 24 77 38 00 00 	movl   $0x3877,(%esp)
  ...
  write(fd, "ff", 2);
    ...
    1080:	00 
    1081:	c7 44 24 04 a1 38 00 	movl   $0x38a1,0x4(%esp)
    1088:	00 
  ...
  if(unlink("dd") >= 0){
    1099:	c7 04 24 3e 39 00 00 	movl   $0x393e,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    10ad:	c7 04 24 52 38 00 00 	movl   $0x3852,(%esp)
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    10c8:	00 
    10c9:	c7 04 24 74 38 00 00 	movl   $0x3874,(%esp)
  ...
  write(fd, "FF", 2);
    ...
    10e6:	00 
    10e7:	c7 44 24 04 95 38 00 	movl   $0x3895,0x4(%esp)
    10ee:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1106:	00 
    1107:	c7 04 24 98 38 00 00 	movl   $0x3898,(%esp)
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1124:	00 
    1125:	c7 44 24 04 00 46 00 	movl   $0x4600,0x4(%esp)
    112c:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    113a:	80 3d 00 46 00 00 66 	cmpb   $0x66,0x4600
    1141:	74 1d                	je     1160 <subdir+0x140>
    printf(1, "dd/dd/../ff wrong content\n");
    1143:	c7 44 24 04 bd 38 00 	movl   $0x38bd,0x4(%esp)
    114a:	00 
    114b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1152:	e8 49 1e 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1168:	c7 44 24 04 d8 38 00 	movl   $0x38d8,0x4(%esp)
    116f:	00 
    1170:	c7 04 24 74 38 00 00 	movl   $0x3874,(%esp)
  ...
  if(unlink("dd/dd/ff") != 0){
    1184:	c7 04 24 74 38 00 00 	movl   $0x3874,(%esp)
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    119f:	00 
    11a0:	c7 04 24 74 38 00 00 	movl   $0x3874,(%esp)
  ...
  if(chdir("dd") != 0){
    11b4:	c7 04 24 3e 39 00 00 	movl   $0x393e,(%esp)
  ...
  if(chdir("dd/../../dd") != 0){
    11c8:	c7 04 24 0c 39 00 00 	movl   $0x390c,(%esp)
  ...
  if(chdir("dd/../../../dd") != 0){
    11dc:	c7 04 24 32 39 00 00 	movl   $0x3932,(%esp)
  ...
  if(chdir("./..") != 0){
    11f0:	c7 04 24 41 39 00 00 	movl   $0x3941,(%esp)
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    120b:	00 
    120c:	c7 04 24 d8 38 00 00 	movl   $0x38d8,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1229:	00 
    122a:	c7 44 24 04 00 46 00 	movl   $0x4600,0x4(%esp)
    1231:	00 
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1252:	00 
    1253:	c7 04 24 74 38 00 00 	movl   $0x3874,(%esp)
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    126e:	00 
    126f:	c7 04 24 8c 39 00 00 	movl   $0x398c,(%esp)
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    128a:	00 
    128b:	c7 04 24 b1 39 00 00 	movl   $0x39b1,(%esp)
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    12a6:	00 
    12a7:	c7 04 24 3e 39 00 00 	movl   $0x393e,(%esp)
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    12c2:	00 
    12c3:	c7 04 24 3e 39 00 00 	movl   $0x393e,(%esp)
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    12de:	00 
    12df:	c7 04 24 3e 39 00 00 	movl   $0x393e,(%esp)
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    12f3:	c7 44 24 04 20 3a 00 	movl   $0x3a20,0x4(%esp)
    12fa:	00 
    12fb:	c7 04 24 8c 39 00 00 	movl   $0x398c,(%esp)
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    130f:	c7 44 24 04 20 3a 00 	movl   $0x3a20,0x4(%esp)
    1316:	00 
    1317:	c7 04 24 b1 39 00 00 	movl   $0x39b1,(%esp)
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    132b:	c7 44 24 04 d8 38 00 	movl   $0x38d8,0x4(%esp)
    1332:	00 
    1333:	c7 04 24 77 38 00 00 	movl   $0x3877,(%esp)
  ...
  if(mkdir("dd/ff/ff") == 0){
    1347:	c7 04 24 8c 39 00 00 	movl   $0x398c,(%esp)
  ...
  if(mkdir("dd/xx/ff") == 0){
    135b:	c7 04 24 b1 39 00 00 	movl   $0x39b1,(%esp)
  ...
  if(mkdir("dd/dd/ffff") == 0){
    136f:	c7 04 24 d8 38 00 00 	movl   $0x38d8,(%esp)
  ...
  if(unlink("dd/xx/ff") == 0){
    1383:	c7 04 24 b1 39 00 00 	movl   $0x39b1,(%esp)
  ...
  if(unlink("dd/ff/ff") == 0){
    1397:	c7 04 24 8c 39 00 00 	movl   $0x398c,(%esp)
  ...
  if(chdir("dd/ff") == 0){
    13ab:	c7 04 24 77 38 00 00 	movl   $0x3877,(%esp)
  ...
  if(chdir("dd/xx") == 0){
    13bf:	c7 04 24 23 3a 00 00 	movl   $0x3a23,(%esp)
  ...
  if(unlink("dd/dd/ffff") != 0){
    13d3:	c7 04 24 d8 38 00 00 	movl   $0x38d8,(%esp)
  ...
  if(unlink("dd/ff") != 0){
    13e7:	c7 04 24 77 38 00 00 	movl   $0x3877,(%esp)
  ...
  if(unlink("dd") == 0){
    13fb:	c7 04 24 3e 39 00 00 	movl   $0x393e,(%esp)
  ...
  if(unlink("dd/dd") < 0){
    140f:	c7 04 24 53 38 00 00 	movl   $0x3853,(%esp)
  ...
  if(unlink("dd") < 0){
    1423:	c7 04 24 3e 39 00 00 	movl   $0x393e,(%esp)
  ...
  printf(1, "subdir ok\n");
    1437:	c7 44 24 04 20 3b 00 	movl   $0x3b20,0x4(%esp)
    143e:	00 
    143f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1446:	e8 55 1b 00 00       	call   2fa0 <printf>
}
  ...
  if(mkdir("dd") != 0){
    printf(1, "subdir mkdir dd failed\n");
    1451:	c7 44 24 04 25 38 00 	movl   $0x3825,0x4(%esp)
    1458:	00 
    1459:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1460:	e8 3b 1b 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "create dd/ff failed\n");
    146a:	c7 44 24 04 3d 38 00 	movl   $0x383d,0x4(%esp)
    1471:	00 
    1472:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1479:	e8 22 1b 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(unlink("dd") >= 0){
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    1483:	c7 44 24 04 e8 42 00 	movl   $0x42e8,0x4(%esp)
    148a:	00 
    148b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1492:	e8 09 1b 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(mkdir("/dd/dd") != 0){
    printf(1, "subdir mkdir dd/dd failed\n");
    149c:	c7 44 24 04 59 38 00 	movl   $0x3859,0x4(%esp)
    14a3:	00 
    14a4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14ab:	e8 f0 1a 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "create dd/dd/ff failed\n");
    14b5:	c7 44 24 04 7d 38 00 	movl   $0x387d,0x4(%esp)
    14bc:	00 
    14bd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14c4:	e8 d7 1a 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "open dd/dd/../ff failed\n");
    14ce:	c7 44 24 04 a4 38 00 	movl   $0x38a4,0x4(%esp)
    14d5:	00 
    14d6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14dd:	e8 be 1a 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(chdir("dd/../../../dd") != 0){
    printf(1, "chdir dd/../../dd failed\n");
    14e7:	c7 44 24 04 18 39 00 	movl   $0x3918,0x4(%esp)
    14ee:	00 
    14ef:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14f6:	e8 a5 1a 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(unlink("dd/dd/ffff") != 0){
    printf(1, "unlink dd/dd/ff failed\n");
    1500:	c7 44 24 04 e3 38 00 	movl   $0x38e3,0x4(%esp)
    1507:	00 
    1508:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    150f:	e8 8c 1a 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    1519:	c7 44 24 04 10 43 00 	movl   $0x4310,0x4(%esp)
    1520:	00 
    1521:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1528:	e8 73 1a 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "open dd/dd/ffff failed\n");
    1532:	c7 44 24 04 59 39 00 	movl   $0x3959,0x4(%esp)
    1539:	00 
    153a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1541:	e8 5a 1a 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(chdir("./..") != 0){
    printf(1, "chdir ./.. failed\n");
    154b:	c7 44 24 04 46 39 00 	movl   $0x3946,0x4(%esp)
    1552:	00 
    1553:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    155a:	e8 41 1a 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(chdir("dd") != 0){
    printf(1, "chdir dd failed\n");
    1564:	c7 44 24 04 fb 38 00 	movl   $0x38fb,0x4(%esp)
    156b:	00 
    156c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1573:	e8 28 1a 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    157d:	c7 44 24 04 34 43 00 	movl   $0x4334,0x4(%esp)
    1584:	00 
    1585:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    158c:	e8 0f 1a 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    printf(1, "create dd/xx/ff succeeded!\n");
    1596:	c7 44 24 04 ba 39 00 	movl   $0x39ba,0x4(%esp)
    159d:	00 
    159e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15a5:	e8 f6 19 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    printf(1, "create dd/ff/ff succeeded!\n");
    15af:	c7 44 24 04 95 39 00 	movl   $0x3995,0x4(%esp)
    15b6:	00 
    15b7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15be:	e8 dd 19 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    15c8:	c7 44 24 04 58 43 00 	movl   $0x4358,0x4(%esp)
    15cf:	00 
    15d0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15d7:	e8 c4 19 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    printf(1, "read dd/dd/ffff wrong len\n");
    15e1:	c7 44 24 04 71 39 00 	movl   $0x3971,0x4(%esp)
    15e8:	00 
    15e9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15f0:	e8 ab 19 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(open("dd", O_WRONLY) >= 0){
    printf(1, "open dd wronly succeeded!\n");
    15fa:	c7 44 24 04 05 3a 00 	movl   $0x3a05,0x4(%esp)
    1601:	00 
    1602:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1609:	e8 92 19 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(open("dd", O_RDWR) >= 0){
    printf(1, "open dd rdwr succeeded!\n");
    1613:	c7 44 24 04 ec 39 00 	movl   $0x39ec,0x4(%esp)
    161a:	00 
    161b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1622:	e8 79 19 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(open("dd", O_CREATE) >= 0){
    printf(1, "create dd succeeded!\n");
    162c:	c7 44 24 04 d6 39 00 	movl   $0x39d6,0x4(%esp)
    1633:	00 
    1634:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    163b:	e8 60 19 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    1645:	c7 44 24 04 80 43 00 	movl   $0x4380,0x4(%esp)
    164c:	00 
    164d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1654:	e8 47 19 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(mkdir("dd/xx/ff") == 0){
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    165e:	c7 44 24 04 44 3a 00 	movl   $0x3a44,0x4(%esp)
    1665:	00 
    1666:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    166d:	e8 2e 19 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(mkdir("dd/ff/ff") == 0){
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    1677:	c7 44 24 04 29 3a 00 	movl   $0x3a29,0x4(%esp)
    167e:	00 
    167f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1686:	e8 15 19 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    1690:	c7 44 24 04 c8 43 00 	movl   $0x43c8,0x4(%esp)
    1697:	00 
    1698:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    169f:	e8 fc 18 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    16a9:	c7 44 24 04 a4 43 00 	movl   $0x43a4,0x4(%esp)
    16b0:	00 
    16b1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16b8:	e8 e3 18 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(unlink("dd/ff/ff") == 0){
    printf(1, "unlink dd/ff/ff succeeded!\n");
    16c2:	c7 44 24 04 98 3a 00 	movl   $0x3a98,0x4(%esp)
    16c9:	00 
    16ca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16d1:	e8 ca 18 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(unlink("dd/xx/ff") == 0){
    printf(1, "unlink dd/xx/ff succeeded!\n");
    16db:	c7 44 24 04 7c 3a 00 	movl   $0x3a7c,0x4(%esp)
    16e2:	00 
    16e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16ea:	e8 b1 18 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(mkdir("dd/dd/ffff") == 0){
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    16f4:	c7 44 24 04 5f 3a 00 	movl   $0x3a5f,0x4(%esp)
    16fb:	00 
    16fc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1703:	e8 98 18 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(unlink("dd") < 0){
    printf(1, "unlink dd failed\n");
    170d:	c7 44 24 04 0e 3b 00 	movl   $0x3b0e,0x4(%esp)
    1714:	00 
    1715:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    171c:	e8 7f 18 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(chdir("dd/ff") == 0){
    printf(1, "chdir dd/ff succeeded!\n");
    1726:	c7 44 24 04 b4 3a 00 	movl   $0x3ab4,0x4(%esp)
    172d:	00 
    172e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1735:	e8 66 18 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(unlink("dd/dd") < 0){
    printf(1, "unlink dd/dd failed\n");
    173f:	c7 44 24 04 f9 3a 00 	movl   $0x3af9,0x4(%esp)
    1746:	00 
    1747:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    174e:	e8 4d 18 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(unlink("dd") == 0){
    printf(1, "unlink non-empty dd succeeded!\n");
    1758:	c7 44 24 04 ec 43 00 	movl   $0x43ec,0x4(%esp)
    175f:	00 
    1760:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1767:	e8 34 18 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(unlink("dd/ff") != 0){
    printf(1, "unlink dd/ff failed\n");
    1771:	c7 44 24 04 e4 3a 00 	movl   $0x3ae4,0x4(%esp)
    1778:	00 
    1779:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1780:	e8 1b 18 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(chdir("dd/xx") == 0){
    printf(1, "chdir dd/xx succeeded!\n");
    178a:	c7 44 24 04 cc 3a 00 	movl   $0x3acc,0x4(%esp)
    1791:	00 
    1792:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1799:	e8 02 18 00 00       	call   2fa0 <printf>
    exit();
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    17bb:	c7 44 24 04 2b 3b 00 	movl   $0x3b2b,0x4(%esp)
    17c2:	00 
    17c3:	8d 7d f1             	lea    -0xf(%ebp),%edi
    17c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    17cd:	e8 ce 17 00 00       	call   2fa0 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    186b:	c7 04 24 3b 3b 00 00 	movl   $0x3b3b,(%esp)
  ...
  for(i = 0; i < 40; i++){
    ...
    1887:	c7 04 24 3b 3b 00 00 	movl   $0x3b3b,(%esp)
  ...
  fd = open(".", 0);
    ...
    18c5:	00 
    18c6:	c7 04 24 44 39 00 00 	movl   $0x3944,(%esp)
  ...
  printf(1, "concreate ok\n");
    19e8:	c7 44 24 04 90 3b 00 	movl   $0x3b90,0x4(%esp)
    19ef:	00 
    19f0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    19f7:	e8 a4 15 00 00       	call   2fa0 <printf>
}
    ...
    1a08:	c7 44 24 04 3e 3b 00 	movl   $0x3b3e,0x4(%esp)
    1a0f:	00 
    1a10:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a17:	e8 84 15 00 00       	call   2fa0 <printf>
        exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    if(pid < 0){
      printf(1, "fork failed\n");
    1a21:	c7 44 24 04 f4 33 00 	movl   $0x33f4,0x4(%esp)
    1a28:	00 
    1a29:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a30:	e8 6b 15 00 00       	call   2fa0 <printf>
      exit();
  ...
  if(n != 40){
    printf(1, "concreate not enough files in directory listing\n");
    1a3a:	c7 44 24 04 0c 44 00 	movl   $0x440c,0x4(%esp)
    1a41:	00 
    1a42:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a49:	e8 52 15 00 00       	call   2fa0 <printf>
    exit();
    ...
    1a5a:	c7 44 24 04 5a 3b 00 	movl   $0x3b5a,0x4(%esp)
    1a61:	00 
    1a62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a69:	e8 32 15 00 00       	call   2fa0 <printf>
    ...
    1a7a:	c7 44 24 04 73 3b 00 	movl   $0x3b73,0x4(%esp)
    1a81:	00 
    1a82:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a89:	e8 12 15 00 00       	call   2fa0 <printf>
        exit();
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    1aa7:	c7 44 24 04 9e 3b 00 	movl   $0x3b9e,0x4(%esp)
    1aae:	00 
    1aaf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ab6:	e8 e5 14 00 00       	call   2fa0 <printf>

  unlink("lf1");
    1abb:	c7 04 24 a8 3b 00 00 	movl   $0x3ba8,(%esp)
    1ac2:	e8 d1 13 00 00       	call   2e98 <unlink>
  unlink("lf2");
    1ac7:	c7 04 24 ac 3b 00 00 	movl   $0x3bac,(%esp)
    1ace:	e8 c5 13 00 00       	call   2e98 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    1ad3:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1ada:	00 
    1adb:	c7 04 24 a8 3b 00 00 	movl   $0x3ba8,(%esp)
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1af8:	00 
    1af9:	c7 44 24 04 c3 3b 00 	movl   $0x3bc3,0x4(%esp)
    1b00:	00 
  ...
  if(link("lf1", "lf2") < 0){
    1b1a:	c7 44 24 04 ac 3b 00 	movl   $0x3bac,0x4(%esp)
    1b21:	00 
    1b22:	c7 04 24 a8 3b 00 00 	movl   $0x3ba8,(%esp)
  ...
  unlink("lf1");
    1b36:	c7 04 24 a8 3b 00 00 	movl   $0x3ba8,(%esp)
    1b3d:	e8 56 13 00 00       	call   2e98 <unlink>

  if(open("lf1", 0) >= 0){
    1b42:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    1b49:	00 
    1b4a:	c7 04 24 a8 3b 00 00 	movl   $0x3ba8,(%esp)
  ...
  fd = open("lf2", 0);
    ...
    1b65:	00 
    1b66:	c7 04 24 ac 3b 00 00 	movl   $0x3bac,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1b83:	00 
    1b84:	c7 44 24 04 00 46 00 	movl   $0x4600,0x4(%esp)
    1b8b:	00 
  ...
  if(link("lf2", "lf2") >= 0){
    1ba5:	c7 44 24 04 ac 3b 00 	movl   $0x3bac,0x4(%esp)
    1bac:	00 
    1bad:	c7 04 24 ac 3b 00 00 	movl   $0x3bac,(%esp)
  ...
  unlink("lf2");
    1bc1:	c7 04 24 ac 3b 00 00 	movl   $0x3bac,(%esp)
    1bc8:	e8 cb 12 00 00       	call   2e98 <unlink>
  if(link("lf2", "lf1") >= 0){
    1bcd:	c7 44 24 04 a8 3b 00 	movl   $0x3ba8,0x4(%esp)
    1bd4:	00 
    1bd5:	c7 04 24 ac 3b 00 00 	movl   $0x3bac,(%esp)
  ...
  if(link(".", "lf1") >= 0){
    1be9:	c7 44 24 04 a8 3b 00 	movl   $0x3ba8,0x4(%esp)
    1bf0:	00 
    1bf1:	c7 04 24 44 39 00 00 	movl   $0x3944,(%esp)
  ...
  printf(1, "linktest ok\n");
    1c05:	c7 44 24 04 4c 3c 00 	movl   $0x3c4c,0x4(%esp)
    1c0c:	00 
    1c0d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c14:	e8 87 13 00 00       	call   2fa0 <printf>
}
  ...
  if(fd < 0){
    printf(1, "create lf1 failed\n");
    1c1f:	c7 44 24 04 b0 3b 00 	movl   $0x3bb0,0x4(%esp)
    1c26:	00 
    1c27:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c2e:	e8 6d 13 00 00       	call   2fa0 <printf>
    exit();
    1c33:	e8 10 12 00 00       	call   2e48 <exit>
  }
  if(write(fd, "hello", 5) != 5){
    printf(1, "write lf1 failed\n");
    1c38:	c7 44 24 04 c9 3b 00 	movl   $0x3bc9,0x4(%esp)
    1c3f:	00 
    1c40:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c47:	e8 54 13 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(link("lf1", "lf2") < 0){
    printf(1, "link lf1 lf2 failed\n");
    1c51:	c7 44 24 04 db 3b 00 	movl   $0x3bdb,0x4(%esp)
    1c58:	00 
    1c59:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c60:	e8 3b 13 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(open("lf1", 0) >= 0){
    printf(1, "unlinked lf1 but it is still there!\n");
    1c6a:	c7 44 24 04 40 44 00 	movl   $0x4440,0x4(%esp)
    1c71:	00 
    1c72:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c79:	e8 22 13 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "open lf2 failed\n");
    1c83:	c7 44 24 04 f0 3b 00 	movl   $0x3bf0,0x4(%esp)
    1c8a:	00 
    1c8b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c92:	e8 09 13 00 00       	call   2fa0 <printf>
    exit();
    1c97:	e8 ac 11 00 00       	call   2e48 <exit>
  }
  if(read(fd, buf, sizeof(buf)) != 5){
    printf(1, "read lf2 failed\n");
    1c9c:	c7 44 24 04 01 3c 00 	movl   $0x3c01,0x4(%esp)
    1ca3:	00 
    1ca4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cab:	e8 f0 12 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    printf(1, "link lf2 lf2 succeeded! oops\n");
    1cb5:	c7 44 24 04 12 3c 00 	movl   $0x3c12,0x4(%esp)
    1cbc:	00 
    1cbd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cc4:	e8 d7 12 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(link("lf2", "lf1") >= 0){
    printf(1, "link non-existant succeeded! oops\n");
    1cce:	c7 44 24 04 68 44 00 	movl   $0x4468,0x4(%esp)
    1cd5:	00 
    1cd6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cdd:	e8 be 12 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(link(".", "lf1") >= 0){
    printf(1, "link . lf1 succeeded! oops\n");
    1ce7:	c7 44 24 04 30 3c 00 	movl   $0x3c30,0x4(%esp)
    1cee:	00 
    1cef:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cf6:	e8 a5 12 00 00       	call   2fa0 <printf>
    exit();
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1d08:	c7 44 24 04 59 3c 00 	movl   $0x3c59,0x4(%esp)
    1d0f:	00 
    1d10:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d17:	e8 84 12 00 00       	call   2fa0 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1d1c:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1d23:	00 
    1d24:	c7 04 24 6a 3c 00 00 	movl   $0x3c6a,(%esp)
...
unlinkread(void)
{
  ...
  write(fd, "hello", 5);
    ...
    1d41:	00 
    1d42:	c7 44 24 04 c3 3b 00 	movl   $0x3bc3,0x4(%esp)
    1d49:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1d61:	00 
    1d62:	c7 04 24 6a 3c 00 00 	movl   $0x3c6a,(%esp)
  ...
  if(unlink("unlinkread") != 0){
    1d78:	c7 04 24 6a 3c 00 00 	movl   $0x3c6a,(%esp)
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1d93:	00 
    1d94:	c7 04 24 6a 3c 00 00 	movl   $0x3c6a,(%esp)
    1d9b:	e8 e8 10 00 00       	call   2e88 <open>
  write(fd1, "yyy", 3);
    1da0:	c7 44 24 08 03 00 00 	movl   $0x3,0x8(%esp)
    1da7:	00 
    1da8:	c7 44 24 04 c1 3c 00 	movl   $0x3cc1,0x4(%esp)
    1daf:	00 
  if(unlink("unlinkread") != 0){
    printf(1, "unlink unlinkread failed\n");
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1dc9:	00 
    1dca:	c7 44 24 04 00 46 00 	movl   $0x4600,0x4(%esp)
    1dd1:	00 
  ...
  if(buf[0] != 'h'){
    1de3:	80 3d 00 46 00 00 68 	cmpb   $0x68,0x4600
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1df7:	00 
    1df8:	c7 44 24 04 00 46 00 	movl   $0x4600,0x4(%esp)
    1dff:	00 
  ...
  unlink("unlinkread");
    1e19:	c7 04 24 6a 3c 00 00 	movl   $0x3c6a,(%esp)
    1e20:	e8 73 10 00 00       	call   2e98 <unlink>
  printf(1, "unlinkread ok\n");
    1e25:	c7 44 24 04 0c 3d 00 	movl   $0x3d0c,0x4(%esp)
    1e2c:	00 
    1e2d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e34:	e8 67 11 00 00       	call   2fa0 <printf>
}
  ...
  if(fd < 0){
    printf(1, "create unlinkread failed\n");
    1e40:	c7 44 24 04 75 3c 00 	movl   $0x3c75,0x4(%esp)
    1e47:	00 
    1e48:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e4f:	e8 4c 11 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(fd < 0){
    printf(1, "open unlinkread failed\n");
    1e59:	c7 44 24 04 8f 3c 00 	movl   $0x3c8f,0x4(%esp)
    1e60:	00 
    1e61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e68:	e8 33 11 00 00       	call   2fa0 <printf>
    exit();
    1e6d:	e8 d6 0f 00 00       	call   2e48 <exit>
  }
  if(unlink("unlinkread") != 0){
    printf(1, "unlink unlinkread failed\n");
    1e72:	c7 44 24 04 a7 3c 00 	movl   $0x3ca7,0x4(%esp)
    1e79:	00 
    1e7a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e81:	e8 1a 11 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    printf(1, "unlinkread read failed");
    1e8b:	c7 44 24 04 c5 3c 00 	movl   $0x3cc5,0x4(%esp)
    1e92:	00 
    1e93:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e9a:	e8 01 11 00 00       	call   2fa0 <printf>
    exit();
    1e9f:	e8 a4 0f 00 00       	call   2e48 <exit>
  }
  if(buf[0] != 'h'){
    printf(1, "unlinkread wrong data\n");
    1ea4:	c7 44 24 04 dc 3c 00 	movl   $0x3cdc,0x4(%esp)
    1eab:	00 
    1eac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1eb3:	e8 e8 10 00 00       	call   2fa0 <printf>
    exit();
    1eb8:	e8 8b 0f 00 00       	call   2e48 <exit>
  }
  if(write(fd, buf, 10) != 10){
    printf(1, "unlinkread write failed\n");
    1ebd:	c7 44 24 04 f3 3c 00 	movl   $0x3cf3,0x4(%esp)
    1ec4:	00 
    1ec5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ecc:	e8 cf 10 00 00       	call   2fa0 <printf>
    exit();
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
    1ee9:	c7 44 24 04 1b 3d 00 	movl   $0x3d1b,0x4(%esp)
    1ef0:	00 
    1ef1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ef8:	e8 a3 10 00 00       	call   2fa0 <printf>

  unlink("f1");
    1efd:	c7 04 24 a9 3b 00 00 	movl   $0x3ba9,(%esp)
    1f04:	e8 8f 0f 00 00       	call   2e98 <unlink>
  unlink("f2");
    1f09:	c7 04 24 ad 3b 00 00 	movl   $0x3bad,(%esp)
  ...
  fname = pid ? "f1" : "f2";
    1f25:	b8 a9 3b 00 00       	mov    $0x3ba9,%eax
  ...
  memset(buf, pid?'p':'c', 512);
    ...
    1f63:	c7 04 24 00 46 00 00 	movl   $0x4600,(%esp)
  ...
  for(i = 0; i < 12; i++){
    ...
    1f77:	00 
    1f78:	c7 44 24 04 00 46 00 	movl   $0x4600,0x4(%esp)
    1f7f:	00 
  ...
  if(pid)
    ...
    1fb2:	b8 ad 3b 00 00       	mov    $0x3bad,%eax
  else
    exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    1fd3:	00 
    1fd4:	c7 44 24 04 00 46 00 	movl   $0x4600,0x4(%esp)
    1fdb:	00 
    ...
    1ff3:	0f be 91 00 46 00 00 	movsbl 0x4600(%ecx),%edx
  ...
  fname = pid ? "f1" : "f2";
    2011:	b8 ad 3b 00 00       	mov    $0x3bad,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
      for(j = 0; j < n; j++){
        if(buf[j] != (i?'p':'c')){
          printf(1, "wrong char\n");
    2020:	c7 44 24 04 3b 3d 00 	movl   $0x3d3b,0x4(%esp)
    2027:	00 
    2028:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    202f:	e8 6c 0f 00 00       	call   2fa0 <printf>
          exit();
  ...
  if(pid < 0){
    printf(1, "fork failed\n");
    2039:	c7 44 24 04 f4 33 00 	movl   $0x33f4,0x4(%esp)
    2040:	00 
    2041:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2048:	e8 53 0f 00 00       	call   2fa0 <printf>
  ...
  for(i = 0; i < 2; i++){
    ...
    if(total != 12*500){
      ...
      exit();
    206b:	b8 a9 3b 00 00       	mov    $0x3ba9,%eax
  if(pid)
    wait();
  else
    exit();
  ...
  unlink("f2");
    207a:	c7 04 24 ad 3b 00 00 	movl   $0x3bad,(%esp)
    2081:	e8 12 0e 00 00       	call   2e98 <unlink>

  printf(1, "twofiles ok\n");
    2086:	c7 44 24 04 58 3d 00 	movl   $0x3d58,0x4(%esp)
    208d:	00 
    208e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2095:	e8 06 0f 00 00       	call   2fa0 <printf>
}
  ...
  for(i = 0; i < 12; i++){
    ...
    20a6:	c7 44 24 04 2a 3d 00 	movl   $0x3d2a,0x4(%esp)
    20ad:	00 
    20ae:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20b5:	e8 e6 0e 00 00       	call   2fa0 <printf>
      exit();
  ...
  if(fd < 0){
    printf(1, "create failed\n");
    20bf:	c7 44 24 04 a9 35 00 	movl   $0x35a9,0x4(%esp)
    20c6:	00 
    20c7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20ce:	e8 cd 0e 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(pid)
    ...
    20e6:	c7 44 24 04 47 3d 00 	movl   $0x3d47,0x4(%esp)
    20ed:	00 
    20ee:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20f5:	e8 a6 0e 00 00       	call   2fa0 <printf>
      exit();
    ...
    2129:	85 c0                	test   %eax,%eax
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    2187:	c7 44 24 04 b8 44 00 	movl   $0x44b8,0x4(%esp)
    218e:	00 
    218f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2196:	e8 05 0e 00 00       	call   2fa0 <printf>
      break;
    }
  }
  if(pid == 0)
  ...
  fd = open("sharedfd", 0);
    ...
    21bb:	00 
    21bc:	c7 04 24 65 3d 00 00 	movl   $0x3d65,(%esp)
  ...
  unlink("sharedfd");
    2220:	c7 04 24 65 3d 00 00 	movl   $0x3d65,(%esp)
  ...
  if(nc == 10000 && np == 10000)
    ...
    223c:	c7 44 24 04 7b 3d 00 	movl   $0x3d7b,0x4(%esp)
    2243:	00 
    2244:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    224b:	e8 50 0d 00 00       	call   2fa0 <printf>
}
  ...
  if(fd < 0){
    printf(1, "fstests: cannot open sharedfd for writing");
    2258:	c7 44 24 04 8c 44 00 	movl   $0x448c,0x4(%esp)
    225f:	00 
    2260:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2267:	e8 34 0d 00 00       	call   2fa0 <printf>
  unlink("sharedfd");
  if(nc == 10000 && np == 10000)
    printf(1, "sharedfd ok\n");
  else
  ...
  if(nc == 10000 && np == 10000)
    ...
    printf(1, "sharedfd ok\n");
    227c:	c7 44 24 04 6e 3d 00 	movl   $0x3d6e,0x4(%esp)
    2283:	00 
    2284:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    228b:	e8 10 0d 00 00       	call   2fa0 <printf>
  else
    printf(1, "sharedfd oops %d %d\n", nc, np);
}
  ...
  if(fd < 0){
    printf(1, "fstests: cannot open sharedfd for reading\n");
    2298:	c7 44 24 04 d8 44 00 	movl   $0x44d8,0x4(%esp)
    229f:	00 
    22a0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22a7:	e8 f4 0c 00 00       	call   2fa0 <printf>
  unlink("sharedfd");
  if(nc == 10000 && np == 10000)
    printf(1, "sharedfd ok\n");
  else
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
    22ca:	a1 d0 45 00 00       	mov    0x45d0,%eax
    22cf:	c7 44 24 04 90 3d 00 	movl   $0x3d90,0x4(%esp)
    22d6:	00 
    22d7:	89 04 24             	mov    %eax,(%esp)
    22da:	e8 c1 0c 00 00       	call   2fa0 <printf>

  fd = open("big", O_CREATE|O_RDWR);
    22df:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    22e6:	00 
    22e7:	c7 04 24 0a 3e 00 00 	movl   $0x3e0a,(%esp)
    ...
    22f3:	85 c0                	test   %eax,%eax
{
  ...
  for(i = 0; i < MAXFILE; i++) {
    ((int*) buf)[0] = i;
    2300:	89 1d 00 46 00 00    	mov    %ebx,0x4600
    if(write(fd, buf, 512) != 512) {
    2306:	c7 44 24 08 00 02 00 	movl   $0x200,0x8(%esp)
    230d:	00 
    230e:	c7 44 24 04 00 46 00 	movl   $0x4600,0x4(%esp)
    2315:	00 
  ...
  fd = open("big", O_RDONLY);
    ...
    2345:	00 
    2346:	c7 04 24 0a 3e 00 00 	movl   $0x3e0a,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
    2358:	a1 d0 45 00 00       	mov    0x45d0,%eax
    235d:	c7 44 24 04 d8 3d 00 	movl   $0x3dd8,0x4(%esp)
    2364:	00 
    2365:	89 04 24             	mov    %eax,(%esp)
    2368:	e8 33 0c 00 00       	call   2fa0 <printf>
    exit();
    ...
    if(((int*)buf)[0] != n) {
    2383:	a1 00 46 00 00       	mov    0x4600,%eax
  ...
  for(;;) {
    ...
    239a:	00 
    239b:	c7 44 24 04 00 46 00 	movl   $0x4600,0x4(%esp)
    23a2:	00 
  ...
  if(unlink("big") < 0) {
    23c5:	c7 04 24 0a 3e 00 00 	movl   $0x3e0a,(%esp)
  ...
  printf(stdout, "big files ok\n");
    23d9:	a1 d0 45 00 00       	mov    0x45d0,%eax
    23de:	c7 44 24 04 31 3e 00 	movl   $0x3e31,0x4(%esp)
    23e5:	00 
    23e6:	89 04 24             	mov    %eax,(%esp)
    23e9:	e8 b2 0b 00 00       	call   2fa0 <printf>
}
  ...
  for(i = 0; i < MAXFILE; i++) {
    ...
    if(write(fd, buf, 512) != 512) {
      printf(stdout, "error: write big file failed\n", i);
    23f5:	a1 d0 45 00 00       	mov    0x45d0,%eax
    23fa:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    23fe:	c7 44 24 04 ba 3d 00 	movl   $0x3dba,0x4(%esp)
    2405:	00 
    2406:	89 04 24             	mov    %eax,(%esp)
    2409:	e8 92 0b 00 00       	call   2fa0 <printf>
      exit();
    ...
    2417:	a1 d0 45 00 00       	mov    0x45d0,%eax
    241c:	c7 44 24 04 0e 3e 00 	movl   $0x3e0e,0x4(%esp)
    2423:	00 
    2424:	89 04 24             	mov    %eax,(%esp)
    2427:	e8 74 0b 00 00       	call   2fa0 <printf>
      exit();
    ...
    2435:	a1 d0 45 00 00       	mov    0x45d0,%eax
    243a:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    243e:	c7 44 24 04 04 45 00 	movl   $0x4504,0x4(%esp)
    2445:	00 
    2446:	89 04 24             	mov    %eax,(%esp)
    2449:	e8 52 0b 00 00       	call   2fa0 <printf>
             n, ((int*)buf)[0]);
      exit();
  ...
  if(fd < 0){
    printf(stdout, "error: creat big failed!\n");
    2453:	a1 d0 45 00 00       	mov    0x45d0,%eax
    2458:	c7 44 24 04 a0 3d 00 	movl   $0x3da0,0x4(%esp)
    245f:	00 
    2460:	89 04 24             	mov    %eax,(%esp)
    2463:	e8 38 0b 00 00       	call   2fa0 <printf>
    exit();
  ...
  for(;;) {
    ...
    if(i == 0) {
      if(n == MAXFILE - 1) {
        printf(stdout, "read only %d blocks from big", n);
    246d:	a1 d0 45 00 00       	mov    0x45d0,%eax
    2472:	c7 44 24 08 8b 00 00 	movl   $0x8b,0x8(%esp)
    2479:	00 
    247a:	c7 44 24 04 f1 3d 00 	movl   $0x3df1,0x4(%esp)
    2481:	00 
    2482:	89 04 24             	mov    %eax,(%esp)
    2485:	e8 16 0b 00 00       	call   2fa0 <printf>
        exit();
  ...
  if(unlink("big") < 0) {
    printf(stdout, "unlink big failed\n");
    248f:	a1 d0 45 00 00       	mov    0x45d0,%eax
    2494:	c7 44 24 04 1e 3e 00 	movl   $0x3e1e,0x4(%esp)
    249b:	00 
    249c:	89 04 24             	mov    %eax,(%esp)
    249f:	e8 fc 0a 00 00       	call   2fa0 <printf>
    exit();
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
    24b8:	a1 d0 45 00 00       	mov    0x45d0,%eax
    24bd:	c7 44 24 04 3f 3e 00 	movl   $0x3e3f,0x4(%esp)
    24c4:	00 
    24c5:	89 04 24             	mov    %eax,(%esp)
    24c8:	e8 d3 0a 00 00       	call   2fa0 <printf>
  fd = open("small", O_CREATE|O_RDWR);
    24cd:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    24d4:	00 
    24d5:	c7 04 24 50 3e 00 00 	movl   $0x3e50,(%esp)
    ...
    24e1:	85 c0                	test   %eax,%eax
{
  ...
  if(fd >= 0){
    ...
    24eb:	a1 d0 45 00 00       	mov    0x45d0,%eax
    24f0:	31 db                	xor    %ebx,%ebx
    24f2:	c7 44 24 04 56 3e 00 	movl   $0x3e56,0x4(%esp)
    24f9:	00 
    24fa:	89 04 24             	mov    %eax,(%esp)
    24fd:	e8 9e 0a 00 00       	call   2fa0 <printf>
  ...
  for(i = 0; i < 100; i++) {
    ...
    250f:	00 
    2510:	c7 44 24 04 8d 3e 00 	movl   $0x3e8d,0x4(%esp)
    2517:	00 
    ...
    2530:	00 
    2531:	c7 44 24 04 98 3e 00 	movl   $0x3e98,0x4(%esp)
    2538:	00 
  ...
  printf(stdout, "writes ok\n");
    2552:	a1 d0 45 00 00       	mov    0x45d0,%eax
    2557:	c7 44 24 04 a3 3e 00 	movl   $0x3ea3,0x4(%esp)
    255e:	00 
    255f:	89 04 24             	mov    %eax,(%esp)
    2562:	e8 39 0a 00 00       	call   2fa0 <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
    ...
    2576:	00 
    2577:	c7 04 24 50 3e 00 00 	movl   $0x3e50,(%esp)
  ...
  if(fd >= 0){
    ...
    258d:	a1 d0 45 00 00       	mov    0x45d0,%eax
    2592:	c7 44 24 04 ae 3e 00 	movl   $0x3eae,0x4(%esp)
    2599:	00 
    259a:	89 04 24             	mov    %eax,(%esp)
    259d:	e8 fe 09 00 00       	call   2fa0 <printf>
  } else {
  ...
  i = read(fd, buf, 2000);
    ...
    25a9:	00 
    25aa:	c7 44 24 04 00 46 00 	movl   $0x4600,0x4(%esp)
    25b1:	00 
  ...
  if(i == 2000) {
    ...
    25c5:	a1 d0 45 00 00       	mov    0x45d0,%eax
    25ca:	c7 44 24 04 e2 3e 00 	movl   $0x3ee2,0x4(%esp)
    25d1:	00 
    25d2:	89 04 24             	mov    %eax,(%esp)
    25d5:	e8 c6 09 00 00       	call   2fa0 <printf>
  } else {
  ...
  if(unlink("small") < 0) {
    25e2:	c7 04 24 50 3e 00 00 	movl   $0x3e50,(%esp)
  ...
  printf(stdout, "small file test ok\n");
    25f6:	a1 d0 45 00 00       	mov    0x45d0,%eax
    25fb:	c7 44 24 04 0a 3f 00 	movl   $0x3f0a,0x4(%esp)
    2602:	00 
    2603:	89 04 24             	mov    %eax,(%esp)
    2606:	e8 95 09 00 00       	call   2fa0 <printf>
}
  ...
  for(i = 0; i < 100; i++) {
    if(write(fd, "aaaaaaaaaa", 10) != 10) {
      printf(stdout, "error: write aa %d new file failed\n", i);
    2612:	a1 d0 45 00 00       	mov    0x45d0,%eax
    2617:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    261b:	c7 44 24 04 24 45 00 	movl   $0x4524,0x4(%esp)
    2622:	00 
    2623:	89 04 24             	mov    %eax,(%esp)
    2626:	e8 75 09 00 00       	call   2fa0 <printf>
      exit();
    262b:	e8 18 08 00 00       	call   2e48 <exit>
    }
    if(write(fd, "bbbbbbbbbb", 10) != 10) {
      printf(stdout, "error: write bb %d new file failed\n", i);
    2630:	a1 d0 45 00 00       	mov    0x45d0,%eax
    2635:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    2639:	c7 44 24 04 48 45 00 	movl   $0x4548,0x4(%esp)
    2640:	00 
    2641:	89 04 24             	mov    %eax,(%esp)
    2644:	e8 57 09 00 00       	call   2fa0 <printf>
      exit();
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
    264e:	a1 d0 45 00 00       	mov    0x45d0,%eax
    2653:	c7 44 24 04 71 3e 00 	movl   $0x3e71,0x4(%esp)
    265a:	00 
    265b:	89 04 24             	mov    %eax,(%esp)
    265e:	e8 3d 09 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
    2668:	a1 d0 45 00 00       	mov    0x45d0,%eax
    266d:	c7 44 24 04 c7 3e 00 	movl   $0x3ec7,0x4(%esp)
    2674:	00 
    2675:	89 04 24             	mov    %eax,(%esp)
    2678:	e8 23 09 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(i == 2000) {
    ...
    printf(stdout, "read failed\n");
    2682:	a1 d0 45 00 00       	mov    0x45d0,%eax
    2687:	c7 44 24 04 82 3c 00 	movl   $0x3c82,0x4(%esp)
    268e:	00 
    268f:	89 04 24             	mov    %eax,(%esp)
    2692:	e8 09 09 00 00       	call   2fa0 <printf>
    exit();
  ...
  if(unlink("small") < 0) {
    printf(stdout, "unlink small failed\n");
    269c:	a1 d0 45 00 00       	mov    0x45d0,%eax
    26a1:	c7 44 24 04 f5 3e 00 	movl   $0x3ef5,0x4(%esp)
    26a8:	00 
    26a9:	89 04 24             	mov    %eax,(%esp)
    26ac:	e8 ef 08 00 00       	call   2fa0 <printf>
    exit();
...
mem(void)
{
  ...
  if((pid = fork()) == 0){
    ...
    26e3:	e8 88 0b 00 00       	call   3270 <malloc>
    ...
    26f5:	e8 d6 0a 00 00       	call   31d0 <free>
    ...
    2707:	e8 64 0b 00 00       	call   3270 <malloc>
    if(m1 == 0) {
    270c:	85 c0                	test   %eax,%eax
    270e:	75 24                	jne    2734 <mem+0x74>
      printf(1, "couldn't allocate mem?!!\n");
    2710:	c7 44 24 04 1e 3f 00 	movl   $0x3f1e,0x4(%esp)
    2717:	00 
    2718:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    271f:	e8 7c 08 00 00       	call   2fa0 <printf>
      exit();
    ...
    2737:	e8 94 0a 00 00       	call   31d0 <free>
    printf(1, "mem ok\n");
    273c:	c7 44 24 04 38 3f 00 	movl   $0x3f38,0x4(%esp)
    2743:	00 
    2744:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    274b:	e8 50 08 00 00       	call   2fa0 <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pid == 0){
    ...
    27b1:	c7 44 24 04 00 46 00 	movl   $0x4600,0x4(%esp)
    27b8:	00 
    ...
    27d0:	38 9a 00 46 00 00    	cmp    %bl,0x4600(%edx)
    ...
    while((n = read(fds[0], buf, cc)) > 0){
      for(i = 0; i < n; i++){
        if((buf[i] & 0xff) != (seq++ & 0xff)){
          printf(1, "pipe1 oops 2\n");
    27f5:	c7 44 24 04 5d 3f 00 	movl   $0x3f5d,0x4(%esp)
    27fc:	00 
    27fd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2804:	e8 97 07 00 00       	call   2fa0 <printf>
  } else {
    printf(1, "fork() failed\n");
    exit();
  }
  ...
  if(pid == 0){
    ...
    2823:	88 82 00 46 00 00    	mov    %al,0x4600(%edx)
  pid = fork();
  seq = 0;
  if(pid == 0){
    close(fds[0]);
  ...
  if(pid == 0){
    ...
    2844:	00 
    2845:	c7 44 24 04 00 46 00 	movl   $0x4600,0x4(%esp)
    284c:	00 
  ...
  if(pid == 0){
    ...
    287e:	c7 44 24 04 6b 3f 00 	movl   $0x3f6b,0x4(%esp)
    2885:	00 
    2886:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    288d:	e8 0e 07 00 00       	call   2fa0 <printf>
    close(fds[0]);
  ...
  printf(1, "pipe1 ok\n");
    28a2:	c7 44 24 04 82 3f 00 	movl   $0x3f82,0x4(%esp)
    28a9:	00 
    28aa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28b1:	e8 ea 06 00 00       	call   2fa0 <printf>
    28b6:	e9 4e ff ff ff       	jmp    2809 <pipe1+0xa9>
{
  ...
  if(pipe(fds) != 0){
    printf(1, "pipe() failed\n");
    28bb:	c7 44 24 04 40 3f 00 	movl   $0x3f40,0x4(%esp)
    28c2:	00 
    28c3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28ca:	e8 d1 06 00 00       	call   2fa0 <printf>
    exit();
    ...
    for(n = 0; n < 5; n++){
      ...
      if(write(fds[1], buf, 1033) != 1033){
        printf(1, "pipe1 oops 1\n");
    28d4:	c7 44 24 04 4f 3f 00 	movl   $0x3f4f,0x4(%esp)
    28db:	00 
    28dc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28e3:	e8 b8 06 00 00       	call   2fa0 <printf>
        exit();
    ...
    printf(1, "fork() failed\n");
    28ed:	c7 44 24 04 8c 3f 00 	movl   $0x3f8c,0x4(%esp)
    28f4:	00 
    28f5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28fc:	e8 9f 06 00 00       	call   2fa0 <printf>
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
    2919:	c7 44 24 04 9b 3f 00 	movl   $0x3f9b,0x4(%esp)
    2920:	00 
    2921:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2928:	e8 73 06 00 00       	call   2fa0 <printf>
  pid1 = fork();
    ...
    2932:	85 c0                	test   %eax,%eax
{
  ...
  if(pid3 == 0){
    ...
    2985:	00 
    2986:	c7 44 24 04 27 3a 00 	movl   $0x3a27,0x4(%esp)
    298d:	00 
    ...
    299b:	c7 44 24 04 a5 3f 00 	movl   $0x3fa5,0x4(%esp)
    29a2:	00 
    29a3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29aa:	e8 f1 05 00 00       	call   2fa0 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    29d1:	00 
    29d2:	c7 44 24 04 00 46 00 	movl   $0x4600,0x4(%esp)
    29d9:	00 
    ...
    29e7:	c7 44 24 04 b9 3f 00 	movl   $0x3fb9,0x4(%esp)
    29ee:	00 
    29ef:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29f6:	e8 a5 05 00 00       	call   2fa0 <printf>
  printf(1, "wait... ");
  wait();
  wait();
  wait();
  ...
  printf(1, "kill... ");
    2a0e:	c7 44 24 04 cc 3f 00 	movl   $0x3fcc,0x4(%esp)
    2a15:	00 
    2a16:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a1d:	e8 7e 05 00 00       	call   2fa0 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
    2a3a:	c7 44 24 04 d5 3f 00 	movl   $0x3fd5,0x4(%esp)
    2a41:	00 
    2a42:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a49:	e8 52 05 00 00       	call   2fa0 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
    2a5d:	c7 44 24 04 de 3f 00 	movl   $0x3fde,0x4(%esp)
    2a64:	00 
    2a65:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a6c:	e8 2f 05 00 00       	call   2fa0 <printf>
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
    2a86:	a1 d0 45 00 00       	mov    0x45d0,%eax
    2a8b:	c7 44 24 04 ea 3f 00 	movl   $0x3fea,0x4(%esp)
    2a92:	00 
    2a93:	89 04 24             	mov    %eax,(%esp)
    2a96:	e8 05 05 00 00       	call   2fa0 <printf>
  if(exec("echo", echo_args) < 0) {
    2a9b:	c7 44 24 04 b0 45 00 	movl   $0x45b0,0x4(%esp)
    2aa2:	00 
    2aa3:	c7 04 24 63 33 00 00 	movl   $0x3363,(%esp)
...
exectest(void)
{
  ...
  if(exec("echo", echo_args) < 0) {
    printf(stdout, "exec echo failed\n");
    2ab5:	a1 d0 45 00 00       	mov    0x45d0,%eax
    2aba:	c7 44 24 04 f5 3f 00 	movl   $0x3ff5,0x4(%esp)
    2ac1:	00 
    2ac2:	89 04 24             	mov    %eax,(%esp)
    2ac5:	e8 d6 04 00 00       	call   2fa0 <printf>
    exit();
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    2b2d:	00 
    2b2e:	c7 04 24 1b 40 00 00 	movl   $0x401b,(%esp)
...
memset(void *dst, int c, uint n)
{
    ...
    2ca3:	8b 45 10             	mov    0x10(%ebp),%eax
    2ca6:	53                   	push   %ebx
    2ca7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *d;
  
  d = dst;
  while(n-- > 0)
    2caa:	85 c0                	test   %eax,%eax
    2cac:	74 14                	je     2cc2 <memset+0x22>
    2cae:	0f b6 4d 0c          	movzbl 0xc(%ebp),%ecx
    2cb2:	31 d2                	xor    %edx,%edx
    2cb4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    *d++ = c;
    2cb8:	88 0c 13             	mov    %cl,(%ebx,%edx,1)
    2cbb:	83 c2 01             	add    $0x1,%edx
memset(void *dst, int c, uint n)
{
  char *d;
  ...
  while(n-- > 0)
    ...
    2cc0:	75 f6                	jne    2cb8 <memset+0x18>
    *d++ = c;
  return dst;
}
    ...
    2cc5:	5d                   	pop    %ebp
    2cc6:	c3                   	ret    
    2cc7:	89 f6                	mov    %esi,%esi
    2cc9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
...
00002ee0 <mytime>:
    2ee0:	b8 15 00 00 00       	mov    $0x15,%eax
    2ee5:	cd 30                	int    $0x30
    2ee7:	c3                   	ret    

00002ee8 <settickets>:
    2ee8:	b8 16 00 00 00       	mov    $0x16,%eax
    2eed:	cd 30                	int    $0x30
    2eef:	c3                   	ret    

00002ef0 <getruntime>:
    2ef0:	b8 17 00 00 00       	mov    $0x17,%eax
    2ef5:	cd 30                	int    $0x30
    2ef7:	c3                   	ret    
    2ef8:	90                   	nop    
    2ef9:	90                   	nop    
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    2f03:	57                   	push   %edi
    2f04:	56                   	push   %esi
    2f05:	89 ce                	mov    %ecx,%esi
    2f07:	53                   	push   %ebx
    2f08:	83 ec 3c             	sub    $0x3c,%esp
  char buf[16];
  int i, neg;
  uint x;
...
printint(int fd, int xx, int base, int sgn)
{
    2f0e:	89 45 cc             	mov    %eax,-0x34(%ebp)
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    2f11:	85 c9                	test   %ecx,%ecx
    2f13:	74 04                	je     2f19 <printint+0x19>
    2f15:	85 d2                	test   %edx,%edx
    2f17:	78 77                	js     2f90 <printint+0x90>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    2f19:	89 d0                	mov    %edx,%eax
    2f1b:	c7 45 d0 00 00 00 00 	movl   $0x0,-0x30(%ebp)
    2f22:	31 db                	xor    %ebx,%ebx
    2f24:	8d 7d e3             	lea    -0x1d(%ebp),%edi
    2f27:	90                   	nop    
  }
  ...
  do{
    buf[i++] = digits[x % base];
    2f28:	31 d2                	xor    %edx,%edx
    2f2a:	f7 f6                	div    %esi
    2f2c:	89 c1                	mov    %eax,%ecx
    2f2e:	0f b6 82 9f 45 00 00 	movzbl 0x459f(%edx),%eax
    2f35:	88 04 1f             	mov    %al,(%edi,%ebx,1)
    2f38:	83 c3 01             	add    $0x1,%ebx
  }while((x /= base) != 0);
    2f3b:	85 c9                	test   %ecx,%ecx
    2f3d:	89 c8                	mov    %ecx,%eax
    2f3f:	75 e7                	jne    2f28 <printint+0x28>
  if(neg)
    2f41:	8b 45 d0             	mov    -0x30(%ebp),%eax
    2f44:	85 c0                	test   %eax,%eax
    2f46:	74 08                	je     2f50 <printint+0x50>
    buf[i++] = '-';
    2f48:	c6 44 1d e3 2d       	movb   $0x2d,-0x1d(%ebp,%ebx,1)
    2f4d:	83 c3 01             	add    $0x1,%ebx

  while(--i >= 0)
    2f50:	8d 73 ff             	lea    -0x1(%ebx),%esi
    2f53:	8d 1c 37             	lea    (%edi,%esi,1),%ebx
    2f56:	8d 7d f3             	lea    -0xd(%ebp),%edi
    2f59:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    putc(fd, buf[i]);
    2f60:	0f b6 03             	movzbl (%ebx),%eax
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    2f63:	83 ee 01             	sub    $0x1,%esi
    2f66:	83 eb 01             	sub    $0x1,%ebx
#include "user.h"
...
{
  write(fd, &c, 1);
    2f69:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    2f70:	00 
    2f71:	89 7c 24 04          	mov    %edi,0x4(%esp)
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
{
  write(fd, &c, 1);
    2f78:	8b 45 cc             	mov    -0x34(%ebp),%eax
    2f7b:	89 04 24             	mov    %eax,(%esp)
    2f7e:	e8 e5 fe ff ff       	call   2e68 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    2f83:	83 fe ff             	cmp    $0xffffffff,%esi
    2f86:	75 d8                	jne    2f60 <printint+0x60>
    putc(fd, buf[i]);
}
    2f88:	83 c4 3c             	add    $0x3c,%esp
    2f8b:	5b                   	pop    %ebx
    2f8c:	5e                   	pop    %esi
    2f8d:	5f                   	pop    %edi
    2f8e:	5d                   	pop    %ebp
  ...
  if(sgn && xx < 0){
    ...
    2f92:	f7 d8                	neg    %eax
    2f94:	c7 45 d0 01 00 00 00 	movl   $0x1,-0x30(%ebp)
    2f9b:	eb 85                	jmp    2f22 <printint+0x22>
    2f9d:	8d 76 00             	lea    0x0(%esi),%esi
...
printf(int fd, char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    2fa9:	8b 55 0c             	mov    0xc(%ebp),%edx
    2fac:	0f b6 02             	movzbl (%edx),%eax
    2faf:	84 c0                	test   %al,%al
    2fb1:	0f 84 e9 00 00 00    	je     30a0 <printf+0x100>
  char *s;
  int c, i, state;
  uint *ap;
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
    2fb7:	8d 4d 10             	lea    0x10(%ebp),%ecx
    2fba:	89 d7                	mov    %edx,%edi
    2fbc:	89 4d e0             	mov    %ecx,-0x20(%ebp)
    2fbf:	31 f6                	xor    %esi,%esi
    2fc1:	eb 21                	jmp    2fe4 <printf+0x44>
    2fc3:	90                   	nop    
    2fc4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
    2fc8:	83 fb 25             	cmp    $0x25,%ebx
    2fcb:	0f 85 d7 00 00 00    	jne    30a8 <printf+0x108>
    2fd1:	66 be 25 00          	mov    $0x25,%si
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    2fd5:	0f b6 47 01          	movzbl 0x1(%edi),%eax
    2fd9:	83 c7 01             	add    $0x1,%edi
    2fdc:	84 c0                	test   %al,%al
    2fde:	0f 84 bc 00 00 00    	je     30a0 <printf+0x100>
    c = fmt[i] & 0xff;
    if(state == 0){
    2fe4:	85 f6                	test   %esi,%esi
  uint *ap;
  ...
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
    2fe6:	0f b6 d8             	movzbl %al,%ebx
    if(state == 0){
    2fe9:	74 dd                	je     2fc8 <printf+0x28>
      if(c == '%'){
        state = '%';
      } else {
        putc(fd, c);
    ...
    2feb:	83 fe 25             	cmp    $0x25,%esi
    2fee:	75 e5                	jne    2fd5 <printf+0x35>
      if(c == 'd'){
    2ff0:	83 fb 64             	cmp    $0x64,%ebx
    2ff3:	90                   	nop    
    2ff4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    2ff8:	0f 84 4a 01 00 00    	je     3148 <printf+0x1a8>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    2ffe:	83 fb 78             	cmp    $0x78,%ebx
    3001:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3008:	0f 84 c2 00 00 00    	je     30d0 <printf+0x130>
    300e:	83 fb 70             	cmp    $0x70,%ebx
    3011:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3018:	0f 84 b2 00 00 00    	je     30d0 <printf+0x130>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    301e:	83 fb 73             	cmp    $0x73,%ebx
    3021:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3028:	0f 84 ca 00 00 00    	je     30f8 <printf+0x158>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    302e:	83 fb 63             	cmp    $0x63,%ebx
    3031:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3038:	0f 84 5a 01 00 00    	je     3198 <printf+0x1f8>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    303e:	83 fb 25             	cmp    $0x25,%ebx
    3041:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3048:	0f 84 22 01 00 00    	je     3170 <printf+0x1d0>
#include "user.h"
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    3051:	8d 45 f3             	lea    -0xd(%ebp),%eax
        ...
        putc(fd, '%');
    3054:	31 f6                	xor    %esi,%esi
    3056:	c6 45 f3 25          	movb   $0x25,-0xd(%ebp)
#include "user.h"
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    306e:	8b 45 08             	mov    0x8(%ebp),%eax
    3071:	8d 4d f3             	lea    -0xd(%ebp),%ecx
      } else if(c == '%'){
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
...
{
  write(fd, &c, 1);
    3077:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    307e:	00 
    307f:	89 4c 24 04          	mov    %ecx,0x4(%esp)
    3083:	89 04 24             	mov    %eax,(%esp)
    3086:	e8 dd fd ff ff       	call   2e68 <write>
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    308b:	0f b6 47 01          	movzbl 0x1(%edi),%eax
    308f:	83 c7 01             	add    $0x1,%edi
    3092:	84 c0                	test   %al,%al
    3094:	0f 85 4a ff ff ff    	jne    2fe4 <printf+0x44>
...
{
  write(fd, &c, 1);
    30a8:	8b 55 08             	mov    0x8(%ebp),%edx
    30ab:	8d 45 f3             	lea    -0xd(%ebp),%eax
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
...
{
  write(fd, &c, 1);
    30b1:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    30b8:	00 
    30b9:	89 44 24 04          	mov    %eax,0x4(%esp)
    30bd:	89 14 24             	mov    %edx,(%esp)
    30c0:	e8 a3 fd ff ff       	call   2e68 <write>
    30c5:	e9 0b ff ff ff       	jmp    2fd5 <printf+0x35>
    30ca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      ...
      if(c == 'd'){
        ...
        printint(fd, *ap, 16, 0);
    30d0:	8b 45 e0             	mov    -0x20(%ebp),%eax
    30d3:	b9 10 00 00 00       	mov    $0x10,%ecx
        ap++;
    30d8:	31 f6                	xor    %esi,%esi
    } else if(state == '%'){
      if(c == 'd'){
        printint(fd, *ap, 10, 1);
        ap++;
    ...
    30e1:	8b 10                	mov    (%eax),%edx
    30e3:	8b 45 08             	mov    0x8(%ebp),%eax
    30e6:	e8 15 fe ff ff       	call   2f00 <printint>
        ap++;
    30eb:	83 45 e0 04          	addl   $0x4,-0x20(%ebp)
    30ef:	e9 e1 fe ff ff       	jmp    2fd5 <printf+0x35>
    30f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      } else if(c == 's'){
        s = (char*)*ap;
    30f8:	8b 55 e0             	mov    -0x20(%ebp),%edx
    30fb:	8b 1a                	mov    (%edx),%ebx
        ap++;
    30fd:	83 c2 04             	add    $0x4,%edx
    3100:	89 55 e0             	mov    %edx,-0x20(%ebp)
        if(s == 0)
    3103:	85 db                	test   %ebx,%ebx
    3105:	0f 84 ba 00 00 00    	je     31c5 <printf+0x225>
          s = "(null)";
        while(*s != 0){
    310b:	0f b6 03             	movzbl (%ebx),%eax
    310e:	84 c0                	test   %al,%al
    3110:	74 2d                	je     313f <printf+0x19f>
    3112:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
          putc(fd, *s);
    3118:	88 45 f3             	mov    %al,-0xd(%ebp)
#include "user.h"
...
{
  write(fd, &c, 1);
    3124:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    312b:	00 
    312c:	89 4c 24 04          	mov    %ecx,0x4(%esp)
    3130:	89 04 24             	mov    %eax,(%esp)
    3133:	e8 30 fd ff ff       	call   2e68 <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    3138:	0f b6 03             	movzbl (%ebx),%eax
    313b:	84 c0                	test   %al,%al
    313d:	75 d9                	jne    3118 <printf+0x178>
#include "user.h"
...
{
  write(fd, &c, 1);
    313f:	31 f6                	xor    %esi,%esi
    3141:	e9 8f fe ff ff       	jmp    2fd5 <printf+0x35>
    ...
    314b:	b9 0a 00 00 00       	mov    $0xa,%ecx
        ap++;
    3150:	66 31 f6             	xor    %si,%si
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
    ...
    315a:	8b 10                	mov    (%eax),%edx
    315c:	8b 45 08             	mov    0x8(%ebp),%eax
    315f:	e8 9c fd ff ff       	call   2f00 <printint>
        ap++;
    3164:	83 45 e0 04          	addl   $0x4,-0x20(%ebp)
    3168:	e9 68 fe ff ff       	jmp    2fd5 <printf+0x35>
...
{
  write(fd, &c, 1);
    3170:	8b 4d 08             	mov    0x8(%ebp),%ecx
    3173:	8d 55 f3             	lea    -0xd(%ebp),%edx
    3176:	31 f6                	xor    %esi,%esi
        }
      } else if(c == 'c'){
        putc(fd, *ap);
        ap++;
        ...
        putc(fd, c);
    3178:	c6 45 f3 25          	movb   $0x25,-0xd(%ebp)
#include "user.h"
...
{
  write(fd, &c, 1);
    317c:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3183:	00 
    3184:	89 54 24 04          	mov    %edx,0x4(%esp)
    3188:	89 0c 24             	mov    %ecx,(%esp)
    318b:	e8 d8 fc ff ff       	call   2e68 <write>
    3190:	e9 40 fe ff ff       	jmp    2fd5 <printf+0x35>
    3195:	8d 76 00             	lea    0x0(%esi),%esi
        ...
        putc(fd, *ap);
    3198:	8b 55 e0             	mov    -0x20(%ebp),%edx
#include "user.h"
...
{
  write(fd, &c, 1);
    31a2:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    31a9:	00 
    31aa:	89 4c 24 04          	mov    %ecx,0x4(%esp)
        while(*s != 0){
          putc(fd, *s);
          s++;
        }
...
{
  write(fd, &c, 1);
    31b1:	8b 45 08             	mov    0x8(%ebp),%eax
    31b4:	89 04 24             	mov    %eax,(%esp)
    31b7:	e8 ac fc ff ff       	call   2e68 <write>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
        putc(fd, *ap);
        ap++;
    31bc:	83 45 e0 04          	addl   $0x4,-0x20(%ebp)
    31c0:	e9 10 fe ff ff       	jmp    2fd5 <printf+0x35>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    31c5:	bb 98 45 00 00       	mov    $0x4598,%ebx
    31ca:	e9 3c ff ff ff       	jmp    310b <printf+0x16b>
    31cf:	90                   	nop    
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    31d1:	8b 0d e8 45 00 00    	mov    0x45e8,%ecx
static Header base;
static Header *freep;
...
free(void *ap)
{
    31d7:	89 e5                	mov    %esp,%ebp
    31d9:	57                   	push   %edi
    31da:	56                   	push   %esi
    31db:	53                   	push   %ebx
    31dc:	8b 7d 08             	mov    0x8(%ebp),%edi
  Header *bp, *p;

  bp = (Header*) ap - 1;
    31df:	8d 5f f8             	lea    -0x8(%edi),%ebx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    31e2:	39 d9                	cmp    %ebx,%ecx
    31e4:	73 24                	jae    320a <free+0x3a>
    31e6:	66 90                	xchg   %ax,%ax
    31e8:	8b 11                	mov    (%ecx),%edx
    31ea:	39 d3                	cmp    %edx,%ebx
    31ec:	72 2a                	jb     3218 <free+0x48>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    31ee:	39 d1                	cmp    %edx,%ecx
    31f0:	72 10                	jb     3202 <free+0x32>
    31f2:	39 d9                	cmp    %ebx,%ecx
    31f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    31f8:	72 1e                	jb     3218 <free+0x48>
    31fa:	39 d3                	cmp    %edx,%ebx
    31fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    3200:	72 16                	jb     3218 <free+0x48>
    3202:	89 d1                	mov    %edx,%ecx
free(void *ap)
{
  Header *bp, *p;
  ...
  bp = (Header*) ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3204:	39 d9                	cmp    %ebx,%ecx
    3206:	66 90                	xchg   %ax,%ax
    3208:	72 de                	jb     31e8 <free+0x18>
    320a:	8b 11                	mov    (%ecx),%edx
    320c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    3210:	eb dc                	jmp    31ee <free+0x1e>
    3212:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    3218:	8b 73 04             	mov    0x4(%ebx),%esi
    321b:	8d 04 f3             	lea    (%ebx,%esi,8),%eax
    321e:	39 d0                	cmp    %edx,%eax
    3220:	74 1a                	je     323c <free+0x6c>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    3222:	89 57 f8             	mov    %edx,-0x8(%edi)
  if(p + p->s.size == bp){
    3225:	8b 51 04             	mov    0x4(%ecx),%edx
    3228:	8d 04 d1             	lea    (%ecx,%edx,8),%eax
    322b:	39 d8                	cmp    %ebx,%eax
    322d:	74 22                	je     3251 <free+0x81>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    322f:	89 19                	mov    %ebx,(%ecx)
  freep = p;
    3231:	89 0d e8 45 00 00    	mov    %ecx,0x45e8
}
    3237:	5b                   	pop    %ebx
    3238:	5e                   	pop    %esi
    3239:	5f                   	pop    %edi
  ...
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    323c:	03 72 04             	add    0x4(%edx),%esi
    bp->s.ptr = p->s.ptr->s.ptr;
    323f:	8b 02                	mov    (%edx),%eax
  bp = (Header*) ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    3241:	89 73 04             	mov    %esi,0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    3244:	8b 51 04             	mov    0x4(%ecx),%edx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    3247:	89 47 f8             	mov    %eax,-0x8(%edi)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    324a:	8d 04 d1             	lea    (%ecx,%edx,8),%eax
    324d:	39 d8                	cmp    %ebx,%eax
    324f:	75 de                	jne    322f <free+0x5f>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    3251:	8b 47 f8             	mov    -0x8(%edi),%eax
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    3254:	03 53 04             	add    0x4(%ebx),%edx
    p->s.ptr = bp->s.ptr;
    3257:	89 01                	mov    %eax,(%ecx)
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    3259:	89 51 04             	mov    %edx,0x4(%ecx)
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
  freep = p;
    325c:	89 0d e8 45 00 00    	mov    %ecx,0x45e8
}
    3262:	5b                   	pop    %ebx
    3263:	5e                   	pop    %esi
    3264:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    327c:	8b 35 e8 45 00 00    	mov    0x45e8,%esi
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    3282:	83 c0 07             	add    $0x7,%eax
    3285:	c1 e8 03             	shr    $0x3,%eax
  if((prevp = freep) == 0){
    3288:	85 f6                	test   %esi,%esi
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    328a:	8d 58 01             	lea    0x1(%eax),%ebx
  if((prevp = freep) == 0){
    328d:	0f 84 95 00 00 00    	je     3328 <malloc+0xb8>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3293:	8b 0e                	mov    (%esi),%ecx
    if(p->s.size >= nunits){
    3295:	8b 41 04             	mov    0x4(%ecx),%eax
    3298:	39 c3                	cmp    %eax,%ebx
    329a:	0f 86 b0 00 00 00    	jbe    3350 <malloc+0xe0>
        p->s.size -= nunits;
        p += p->s.size;
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*) (p + 1);
    32a0:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    32a7:	90                   	nop    
    }
    if(p == freep)
    32a8:	3b 0d e8 45 00 00    	cmp    0x45e8,%ecx
    32ae:	89 ca                	mov    %ecx,%edx
    32b0:	74 34                	je     32e6 <malloc+0x76>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    32b2:	8b 0a                	mov    (%edx),%ecx
    if(p->s.size >= nunits){
    32b4:	8b 41 04             	mov    0x4(%ecx),%eax
    32b7:	39 c3                	cmp    %eax,%ebx
    32b9:	77 ed                	ja     32a8 <malloc+0x38>
    32bb:	89 d6                	mov    %edx,%esi
    32bd:	89 ca                	mov    %ecx,%edx
      if(p->s.size == nunits)
    32bf:	39 c3                	cmp    %eax,%ebx
    32c1:	74 1d                	je     32e0 <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
    32c3:	29 d8                	sub    %ebx,%eax
        p += p->s.size;
    32c5:	8d 14 c1             	lea    (%ecx,%eax,8),%edx
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
        prevp->s.ptr = p->s.ptr;
        ...
        p->s.size -= nunits;
    32c8:	89 41 04             	mov    %eax,0x4(%ecx)
        p += p->s.size;
        p->s.size = nunits;
    32cb:	89 5a 04             	mov    %ebx,0x4(%edx)
      }
      freep = prevp;
    32ce:	89 35 e8 45 00 00    	mov    %esi,0x45e8
      return (void*) (p + 1);
    32d4:	8d 42 08             	lea    0x8(%edx),%eax
    }
    if(p == freep)
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
        prevp->s.ptr = p->s.ptr;
    32e0:	8b 01                	mov    (%ecx),%eax
    32e2:	89 06                	mov    %eax,(%esi)
    32e4:	eb e8                	jmp    32ce <malloc+0x5e>
morecore(uint nu)
{
  char *p;
  Header *hp;
  ...
  if(nu < PAGE)
    32e6:	81 fb ff 0f 00 00    	cmp    $0xfff,%ebx
    32ec:	bf 00 10 00 00       	mov    $0x1000,%edi
    32f1:	b8 00 80 00 00       	mov    $0x8000,%eax
    32f6:	76 04                	jbe    32fc <malloc+0x8c>
    32f8:	89 df                	mov    %ebx,%edi
    32fa:	89 f0                	mov    %esi,%eax
    nu = PAGE;
  p = sbrk(nu * sizeof(Header));
    32fc:	89 04 24             	mov    %eax,(%esp)
    32ff:	e8 cc fb ff ff       	call   2ed0 <sbrk>
  if(p == (char*) -1)
    3304:	83 f8 ff             	cmp    $0xffffffff,%eax
    3307:	74 18                	je     3321 <malloc+0xb1>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
    3309:	89 78 04             	mov    %edi,0x4(%eax)
  free((void*)(hp + 1));
    330c:	83 c0 08             	add    $0x8,%eax
    330f:	89 04 24             	mov    %eax,(%esp)
    3312:	e8 b9 fe ff ff       	call   31d0 <free>
  return freep;
    3317:	8b 15 e8 45 00 00    	mov    0x45e8,%edx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
    331d:	85 d2                	test   %edx,%edx
    331f:	75 91                	jne    32b2 <malloc+0x42>
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
    3321:	31 c0                	xor    %eax,%eax
    3323:	eb b2                	jmp    32d7 <malloc+0x67>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    3328:	c7 05 e8 45 00 00 e0 	movl   $0x45e0,0x45e8
    332f:	45 00 00 
    base.s.size = 0;
    3332:	be e0 45 00 00       	mov    $0x45e0,%esi
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    3337:	c7 05 e0 45 00 00 e0 	movl   $0x45e0,0x45e0
    333e:	45 00 00 
    base.s.size = 0;
    3341:	c7 05 e4 45 00 00 00 	movl   $0x0,0x45e4
    3348:	00 00 00 
    334b:	e9 43 ff ff ff       	jmp    3293 <malloc+0x23>
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
    3350:	89 ca                	mov    %ecx,%edx
    3352:	e9 68 ff ff ff       	jmp    32bf <malloc+0x4f>
