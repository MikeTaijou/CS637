...
main(int argc, char *argv[])
{
  ...
  1c:	7e 61                	jle    7f <main+0x7f>
  1e:	bb 01 00 00 00       	mov    $0x1,%ebx
    printf(1, "%s%s", argv[i], i+1 < argc ? " " : "\n");
  23:	83 c3 01             	add    $0x1,%ebx
  26:	39 de                	cmp    %ebx,%esi
  28:	7e 31                	jle    5b <main+0x5b>
  2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  30:	c7 44 24 0c e7 07 00 	movl   $0x7e7,0xc(%esp)
  37:	00 
  38:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  3c:	83 c3 01             	add    $0x1,%ebx
  3f:	c7 44 24 04 e9 07 00 	movl   $0x7e9,0x4(%esp)
  46:	00 
  47:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  4e:	89 44 24 08          	mov    %eax,0x8(%esp)
  52:	e8 d9 03 00 00       	call   430 <printf>
  57:	39 de                	cmp    %ebx,%esi
  59:	7f d5                	jg     30 <main+0x30>
  5b:	c7 44 24 0c ee 07 00 	movl   $0x7ee,0xc(%esp)
  62:	00 
  63:	8b 44 b7 fc          	mov    -0x4(%edi,%esi,4),%eax
  67:	c7 44 24 04 e9 07 00 	movl   $0x7e9,0x4(%esp)
  6e:	00 
  6f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  76:	89 44 24 08          	mov    %eax,0x8(%esp)
  7a:	e8 b1 03 00 00       	call   430 <printf>
  exit();
  7f:	e8 54 02 00 00       	call   2d8 <exit>
  84:	90                   	nop    
  85:	90                   	nop    
  86:	90                   	nop    
  87:	90                   	nop    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3be:	0f b6 82 f7 07 00 00 	movzbl 0x7f7(%edx),%eax
...
putc(int fd, char c)
{
 ...
 650:	e9 10 fe ff ff       	jmp    465 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 655:	bb f0 07 00 00       	mov    $0x7f0,%ebx
...
free(void *ap)
{
 ...
 661:	8b 0d 10 08 00 00    	mov    0x810,%ecx
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6bf:	89 19                	mov    %ebx,(%ecx)
  freep = p;
 6c1:	89 0d 10 08 00 00    	mov    %ecx,0x810
}
 6c7:	5b                   	pop    %ebx
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 ...
 6e9:	89 51 04             	mov    %edx,0x4(%ecx)
    ...
    p->s.ptr = bp;
  freep = p;
 6ec:	89 0d 10 08 00 00    	mov    %ecx,0x810
}
 6f2:	5b                   	pop    %ebx
 6f3:	5e                   	pop    %esi
 6f4:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 35 10 08 00 00    	mov    0x810,%esi
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
malloc(uint nbytes)
{
 ...
 737:	90                   	nop    
    ...
    if(p == freep)
 738:	3b 0d 10 08 00 00    	cmp    0x810,%ecx
 ...
 75b:	89 5a 04             	mov    %ebx,0x4(%edx)
      ...
      freep = prevp;
 75e:	89 35 10 08 00 00    	mov    %esi,0x810
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 7a2:	e8 b9 fe ff ff       	call   660 <free>
  return freep;
 7a7:	8b 15 10 08 00 00    	mov    0x810,%edx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 7b5:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7b8:	c7 05 10 08 00 00 08 	movl   $0x808,0x810
 7bf:	08 00 00 
    base.s.size = 0;
 7c2:	be 08 08 00 00       	mov    $0x808,%esi
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7c7:	c7 05 08 08 00 00 08 	movl   $0x808,0x808
 7ce:	08 00 00 
    base.s.size = 0;
 7d1:	c7 05 0c 08 00 00 00 	movl   $0x0,0x80c
 7d8:	00 00 00 
