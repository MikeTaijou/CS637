...
main(int argc, char *argv[])
{
  ...
  67:	c7 44 24 04 fb 07 00 	movl   $0x7fb,0x4(%esp)
  6e:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3be:	0f b6 82 1b 08 00 00 	movzbl 0x81b(%edx),%eax
...
putc(int fd, char c)
{
 ...
 650:	e9 10 fe ff ff       	jmp    465 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 655:	bb 14 08 00 00       	mov    $0x814,%ebx
...
free(void *ap)
{
 ...
 661:	8b 0d 34 08 00 00    	mov    0x834,%ecx
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6bf:	89 19                	mov    %ebx,(%ecx)
  freep = p;
 6c1:	89 0d 34 08 00 00    	mov    %ecx,0x834
}
 6c7:	5b                   	pop    %ebx
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 ...
 6e9:	89 51 04             	mov    %edx,0x4(%ecx)
    ...
    p->s.ptr = bp;
  freep = p;
 6ec:	89 0d 34 08 00 00    	mov    %ecx,0x834
}
 6f2:	5b                   	pop    %ebx
 6f3:	5e                   	pop    %esi
 6f4:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 35 34 08 00 00    	mov    0x834,%esi
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
malloc(uint nbytes)
{
 ...
 737:	90                   	nop    
    ...
    if(p == freep)
 738:	3b 0d 34 08 00 00    	cmp    0x834,%ecx
 ...
 75b:	89 5a 04             	mov    %ebx,0x4(%edx)
      ...
      freep = prevp;
 75e:	89 35 34 08 00 00    	mov    %esi,0x834
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 7a2:	e8 b9 fe ff ff       	call   660 <free>
  return freep;
 7a7:	8b 15 34 08 00 00    	mov    0x834,%edx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 7b5:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7b8:	c7 05 34 08 00 00 2c 	movl   $0x82c,0x834
 7bf:	08 00 00 
    base.s.size = 0;
 7c2:	be 2c 08 00 00       	mov    $0x82c,%esi
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7c7:	c7 05 2c 08 00 00 2c 	movl   $0x82c,0x82c
 7ce:	08 00 00 
    base.s.size = 0;
 7d1:	c7 05 30 08 00 00 00 	movl   $0x0,0x830
 7d8:	00 00 00 
